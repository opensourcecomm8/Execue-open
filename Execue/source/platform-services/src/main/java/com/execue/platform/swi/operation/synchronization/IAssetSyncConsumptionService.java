...
public interface IAssetSyncConsumptionService {

   public void consumeAssetSyncInfo (AssetSyncAbsorptionContext assetSyncAbsorptionContext) throws AssetSynchronizationException;
