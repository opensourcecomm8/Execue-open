...
package com.execue.util.cryptography.exception;

import com.execue.core.exception.ExeCueException;

/**
 * This exception class defines the exception for cryptography service
 * 
 * @author Vishay
 * @version 1.0
 * @since 14/08/09
 */
public class CryptographyException extends ExeCueException {
