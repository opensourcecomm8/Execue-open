...
package com.execue.util.querygen.impl.teradata;
...
/**
 * Teradata specific query generation utilities come here
 * 
 * @author John Mallavalli
 * @version 1.0
 * @since 20/12/2011
 */
public class TeradataQueryGenerationUtilServiceImpl extends SQLQueryGenerationUtilServiceImpl {
   ...
   public String createIndexPingStatement (String indexName, QueryTable queryTable) {
      ...
      throw new UnsupportedOperationException("Yet to implement in Teradata");
   }
   ...
   public String createMaximumDataLengthSelectStatement (QueryTable queryTable, QueryColumn queryColumn) {
      ...
      maxDataLengthSelectStatement.append(SQL_TERADATA_LENGTH_FUNCTION);
      maxDataLengthSelectStatement.append(SQL_SUBQUERY_START_WRAPPER);
      maxDataLengthSelectStatement.append(SQL_TERADATA_CAST_FUNCTION);
      maxDataLengthSelectStatement.append(SQL_SUBQUERY_START_WRAPPER);
      maxDataLengthSelectStatement.append(createColumnRepresentation(queryColumn));
      maxDataLengthSelectStatement.append(" AS VARCHAR(99)");
   ...
   protected String createTableRepresentation (QueryTable queryTable) {
      ...
      sb.append(queryTable.getOwner()).append(SQL_ALIAS_SEPERATOR).append(tableName);
      return sb.toString();
   }
