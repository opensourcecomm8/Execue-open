 ...
 */
public class PopularityCollectionServiceTest extends ExeCueBaseTest {
   ...
   @Test
   public void testCollectPopularityInfo () {
      ...
      try {
         getPopularityCollectionService().collectPopularityInfo(popularityRestorationContext);
