...
public class TestQueryIntefaceSearchAction extends QIActionBaseTest {
   ...
   public void testMetrics () {
    ...
    @Test
   public void testMetricsWithSelectText () {
      String retString = null;
      try {
         String data = getResourceData("/qi/metrics_selectTextQuery.xml");
         QueryInterfaceSearchAction action = getSearchAction();
         action.setRequest(data);
         retString = action.search();
      } catch (Exception e) {
  ...
  // @Test
   public void testFreeForm () {
      String retString = null;
      try {
         String data = getResourceData("/qi/freeform.xml");
         QueryInterfaceSearchAction action = getSearchAction();
         action.setRequest(data);
         retString = action.search();
      } catch (Exception e) {
