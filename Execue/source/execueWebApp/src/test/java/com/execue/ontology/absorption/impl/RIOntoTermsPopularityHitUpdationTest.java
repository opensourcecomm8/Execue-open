 ...
 * @author MurthysN
 */
public class RIOntoTermsPopularityHitUpdationTest extends ExeCueBaseTest {
   ...
   @Test
   public void testPopularityHitUpdation () {
      try {
         long modelId = 104L;
         Long userId = 1L;
         ...
         popularityHitMaintenanceContext.setUserId(userId);
         getRIOntermsPopularityHitMaintainenceJobService().scheduleRIOntoTermPopularityHitMaintainenceJob(
                  popularityHitMaintenanceContext);
