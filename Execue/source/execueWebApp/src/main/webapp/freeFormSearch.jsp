...
<div style="margin:auto;width:100%">
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
			  <td valign="top">
				<form action='<c:out value="${basePath}"/>/semanticSearch.action' onSubmit="return submitDataFreeForm(true)" id="searchFormId"
  ...
  <tr  >
    <td height="10" valign="middle" colspan="3"><img src="<c:out value="${basePath}"/>/images/1pix.gif" width="1" height="10" /></td>
  ...
  <tr  >
   ...
   <s:set name="metric" value="request" />
    ...
    <td width="600" height="25" valign="middle"><div style="padding-left:6px;margin-top:0px;"><input id="metrics" type="text" maxlength="500"	 value="<s:property value='#metric' />" size="" style="border:none;font-size:13px;font-family:Arial;color:#525252;padding-top:4px;padding-left:3px;height:21px;background: url(<c:out value="${basePath}"/>/images/text-bg.jpg) no-repeat;"  /></div></td>
    ...
    <input type="image" name="search"
							id="searchBtnFreeForm" src="<c:out value="${basePath}"/>/images/search.png" alt="Search" title="Search" tabindex="-1"  class="imgNoBorder1" /></div></td>
    <td width="22" align="left" valign="middle">
    <!--
    <s:if test="result.cacheResultPresent" ><input type="image" name="search"
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="7%"  align="left"><div id="showBookmarksSearchLink"  ><a href="javascript:;" class="links_white" id="bookmarksSearchId" style="font-size:7pt;"><s:text name="execue.freeform.SavedQueries.link" /></a></div>
          <div id="loadingShowBookmarksSearchLink" style="display: none;padding-left:33px;padding-right:33px;"><img
									src="<c:out value="${basePath}"/>/images/loaderTrans.gif" /></div></td>
        <td width="7%" align="left" style="padding-left:15px;"><div id="showExamplesLink"  ><a href="javascript:;" class="links_white" id="examplesId-freeform" style="font-size:7pt;"><s:text name="execue.freeform.examples.link" /></a></div></td>
                                    
         <td width="7%" align="right" style="padding-left:15px;padding-right:15px;" ><a href="<c:out value="${basePath}"/>/execueHome.action?type=QI" class="links_white" style="font-size:7pt;padding-right:4px;" ><s:text name="execue.freeform.advancedSearch.link"  /></a></td>
    ...
    <td>&nbsp;</td>
              ...
              <!-------------------------------------------------------------------------------->
					...
					<tr>
						<td  align="left" valign="top"><!-- div id="pleaseWaitDiv" style="display:none;margin:auto;width:133px;margin-top:5px;margin-bottom:5px;"><img  id="waiting_img" src="images/wait.gif" width="133" height="11" /></div--></td>
					</tr>
					<tr>
					<tr>
...
<table border="0" cellpadding="0" cellspacing="0" width="310" align="left" >
     ...
     src="<c:out value="${basePath}"/>/images/boxTemplate_r1_c1.gif" width="15" height="40"
     border="0" id="boxTemplate_r1_c1" alt="" /></td>
          <td background="<c:out value="${basePath}"/>/images/boxTemplate_r1_c2.gif" align="right"><a id="closeButtonLink" alt="Close" title="Close" href="#"><img
     name="boxTemplate_r1_c2" src="<c:out value="${basePath}"/>/images/cButton.png" border="0" id="boxTemplate_r1_c2" /></a></td>
          <td width="15"><img
     name="boxTemplate_r1_c3" src="<c:out value="${basePath}"/>/images/boxTemplate_r1_c3.gif"
     width="15" height="40" border="0" id="boxTemplate_r1_c3"
     alt="Close" title="Close"/></td>
          <td width="13"><img src="<c:out value="${basePath}"/>/images/spacer.gif" width="1" height="40"
     border="0" alt="" /></td>
          </tr>
        <tr>
          <td background="<c:out value="${basePath}"/>/images/boxTemplate_r2_c1.gif"><img
     name="boxTemplate_r2_c1" src="<c:out value="${basePath}"/>/images/boxTemplate_r2_c1.gif"
     width="15" height="10" border="0" id="boxTemplate_r2_c1" alt="" /></td>
          ...
          <td background="<c:out value="${basePath}"/>/images/boxTemplate_r2_c3.gif" ><img
     name="boxTemplate_r2_c3" src="<c:out value="${basePath}"/>/images/boxTemplate_r2_c3.gif"
     width="15" height="10" border="0" id="boxTemplate_r2_c3" alt="" /></td>
          <td><img src="<c:out value="${basePath}"/>/images/spacer.gif" width="1" height="10"
     border="0" alt="" /></td>
          </tr>
        <tr>
          <td><img name="boxTemplate_r3_c1"
     src="<c:out value="${basePath}"/>/images/boxTemplate_r3_c1.gif" width="15" height="13"
     border="0" id="boxTemplate_r3_c1" alt="" /></td>
          <td background="<c:out value="${basePath}"/>/images/boxTemplate_r3_c2.gif" valign="top"><img
     name="boxTemplate_r3_c2" src="<c:out value="${basePath}"/>/images/boxTemplate_r3_c2.gif"
     width="25" height="13" border="0" id="boxTemplate_r3_c2" alt="" /></td>
          <td><img name="boxTemplate_r3_c3"
     src="<c:out value="${basePath}"/>/images/boxTemplate_r3_c3.gif" width="15" height="13"
     border="0" id="boxTemplate_r3_c3" alt="" /></td>
          <td><img src="<c:out value="${basePath}"/>/images/spacer.gif" width="1" height="13"
     border="0" alt="" /></td>
          </tr>
        </table>
</div>
...
$("a#uservoice-feedback-tab").css("background-image","url(<c:out value="${basePath}"/>/images/feedback_tab_white.png)");

$(function(){
	$("#closeButtonLink").mouseover(function(){
		$(this).find("img").attr("src","<c:out value="${basePath}"/>/images/cButtonHover.png");								 
	});
	$("#closeButtonLink").mouseout(function(){
		$(this).find("img").attr("src","<c:out value="${basePath}"/>/images/cButton.png");								 
	});
