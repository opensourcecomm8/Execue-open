...
<script language="JavaScript" src="<c:out value="${basePath}"/>/js/jquery.js"></script>
<script language="JavaScript" src="<c:out value="${basePath}"/>/js/qinew/XMLWriter.js"></script>
<script language="JavaScript" src="<c:out value="${basePath}"/>/js/qinew/qiSuggestTerm.js"></script>
<script language="JavaScript" src="<c:out value="${basePath}"/>/js/qinew/qiSuggestCondition.js"></script>
<script language="JavaScript" src="<c:out value="${basePath}"/>/js/qinew/qiSuggestTB.js"></script>
...
<style>
.login_bg {
	background-image: url(<c:out value="${basePath}"/>/images/login_r2_c1.jpg);
}
</style>
<style>
.login_bg {
...
<style>
.top-bg {
	background-image: url(<c:out value="${basePath}"/>/images/results_header_bg.jpg);
...
.technology-1 {
	background-image: url(<c:out value="${basePath}"/>/images/top-bg-inner-2.png);
	background-repeat: repeat-x;
...
<div style="margin:auto;width:91%">
  ...
  <tr >
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="8%" valign="top"><div style="padding-top:0px;padding-left:0px;padding-right:0px;padding-bottom:1px;"><a href="index.jsp"><img name="index_r1_c1" src="<c:out value="${basePath}"/>/images/inner-page-logo.png" border="0"
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr >
		...
		<span style="padding-left:1px;color:#333;">
                <a href="execueHome.action?type=SI"	 class="breadCrumbLink"><s:text name="execue.home.link" /></a><Span class="textArrow"> >> </Span> <span class="breadCrumbNoLink"><s:text name="execue.SignIn.breadcrumb" /></span>
		</span></td>
	</tr>
								...
								<table cellspacing="0" cellpadding="2" width="70%"
									...
									<tr>
										...
										<td height="30" align="left"><label> <input
											...
											src="<c:out value="${basePath}"/>/images/login_submit.gif"> <a
...
<tr>
     ...
     width="279" height="40" border="0" id="boxTemplate_r1_c2" alt=""/></td>
          <td width="15"><img
     name="boxTemplate_r1_c3" src="images/boxTemplate_r1_c3.gif"
     width="15" height="40" border="0" id="boxTemplate_r1_c3"
     alt="Close" title="Close"/></td>
          <td width="13"><img src="images/spacer.gif" width="1" height="15"
     border="0" alt="" /></td>
        </tr>
        <tr>
