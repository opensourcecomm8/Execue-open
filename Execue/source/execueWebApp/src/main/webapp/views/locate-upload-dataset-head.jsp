...
/*function getDSConnection(dsName){  
	$.post("../swi/showDataSource.action?dataSource.name="+dsName,{},function(data){
		 $("#connectionInfo").fadeIn("fast");
         $("#connectionInfo").empty();
         $("#connectionInfo").append(data);
         $("#connectionInfo").show();    
...
var static9 = "<tbody><tr><td ><div style='width: 100%; border: 0px; padding: 0px; height: 175px;'><table border='0'><tbody>";
