...
$(document).ready(function(){
  ...
  actionMP6="showAssetsGrain";
	...
	if($pathName.indexOf(homePage)>-1)$("#bi_home").attr("src","../images/publisherHome_hover.jpg");
	...
	if(($pathName.indexOf(action3)>-1))$("#bi_bt").attr("src","../images/pub/searchView_hover.jpg");
	...
	if(($pathName.indexOf(action7)>-1)||($pathName.indexOf(action8)>-1)||($pathName.indexOf(action9)>-1))$("#bi_system").attr("src","../images/pub/adminSecurity_hover.jpg");
	if(($pathName.indexOf(action4)>-1)||($pathName.indexOf(action5)>-1))$("#bi_da").attr("src","../images/pub/preferences_hover.jpg");
...
<table width="1164" border="0" align="center" cellpadding="0"  cellspacing="0">
  <tr>
    <td height="18" align="left" style="padding-left:1px;" ><admin:showBreadcrumb homeName="Semantifi" homeLink="../index.jsp" appDisplayName="App" assetDisplayName="Dataset Collection"/></td>
  </tr>
</table>
