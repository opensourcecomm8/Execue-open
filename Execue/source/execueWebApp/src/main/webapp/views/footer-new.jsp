...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="30" valign="middle" background="<c:out value='${basePath}' />/images/semantifi3b/footer-bg-3.jpg">
        
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
          <td width="1%" height="30" align="left">&nbsp;</td>
            <td width="50%" height="30" align="left"><a href="javascript:openWIndow('http://www.semantifi.com/privacy.html');"  class="footer-sublink-bottom">Privacy policy</a>&nbsp;&nbsp;
