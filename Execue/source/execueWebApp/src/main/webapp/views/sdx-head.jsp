...
function showColumnInfo(tableName,virtualTable) {
	...
	/*#pagination
	if(resetFlag==true){
		//console.log("After clicking on pageno, u have clicked resetpage no"+resetPageNo);
		subList(resetPageNo);		
	}else{*/
	  ...
	  /*$ct =$("#ccolName").val();
	    ...
	    if(len2>20){
	    		$("#columnListForm .col").width(180);	
	    }else{
	    	$("#columnListForm .col").width(len2*9);
	    }*/
