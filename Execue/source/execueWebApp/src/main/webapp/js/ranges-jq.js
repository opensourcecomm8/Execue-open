...
function processAddImageClick(e){ 
		...
		var $addImage=$("<img style='display:none;' class='addRow'  title='Add range below' alt='Add range below' src='../images/plus.gif' />");
		$addImage.bind("click",processAddImageClick);
		var $delRowImage=$("<img style='display:none;'   title='Remove this range' alt='Remove this range' src='../images/remove.jpg' class='delRow' />");
