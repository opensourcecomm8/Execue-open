...
function addRowToTable(index) {
  ...
  if (rowCount == (nonDataRowCount+20)) {
    alert('Maximum number of range definitions is 20');
      ...
      newCell.innerHTML = "<img class='plusminus' src='../images/plus.gif' alt='Add range below' title='Add range below' onclick='return addRowToTable("+nextIndex+")' tabindex='-1'/>";
      
      newCell = newRow.insertCell(4);
      newCell.innerHTML = "<img class='plusminus' src='../images/remove.jpg' alt='Remove this range' title='Remove this range' onclick='return removeRowFromTable("+nextIndex+")' tabindex='-1'/>";
...
function adjustIndex(index, nextIndex, lowerLimit, upperLimit, description, id, tableLength) {
    ...
    cell.innerHTML = "<img class='plusminus' src='../images/plus.gif' alt='Add range below' title='Add range below' onclick='return addRowToTable("+nextIndex+")'/>";
    
    cell = row.insertCell(4);
    cell.innerHTML = "<img class='plusminus' src='../images/remove.jpg' alt='Remove this range' title='Remove this range' onclick='return removeRowFromTable("+nextIndex+")'/>";
}
