(function($) {
	$.fn.qiSuggestCondition = function(options) {
		...
		return this.each(function() {
			...
			$seperatorFlag=false;
			$seperator=$("<li style='width:501px;height:1px;'><img src='images/1pix.gif' id='sep1' width='1' height='1' border='0' /></li>");
			$seperator1=$("<li style='width:502px;height:1px;'><img src='images/1pix.gif' id='sep2'  width='1' height='1' border='0' /></li>");
			...
			function update(text, el) {
				...
				if (operatorType == 1) {
					...
					/*if($opCount==1){
							$("<div style='width:500px;'><img src='images/1pix.gif' width='1' height='1' /></div>").insertBefore($conButton);
					}*/
			...
			function prepareTemplate() {
				...
				$v2 = $('<span style="padding-right:10px;text-decoration:underline;">value 2</span>').bind('click', function(e) {
					handleValue2onAddCondition();
				}).addClass('link_blue');
			...
			$conButton = $('<a href="javascript:;" class="conditionSpan"><img hspace="3" src="images/addConditionNew.gif" align="left" alt="Add Condition" title="Add Condition" border="0" class="imgNoBorder" /></a>')
					.bind('click', function(e) {
						addCondition();
							// hideButtons();
			...
			//holder
					//.append("<div style='width:100%;float:left;'><img src='images/1pix.gif' width='1' height='1' /></div>");
			...
			function generateSnapShot() {
				...
				$snapBit.bind("mouseover",function(){
									$(this).find("img").attr("src","images/deleteButtNew.gif");
									}).bind("mouseout",function(){
								    $(this).find("img").attr("src","images/deleteButtNewEmpty.gif");
									});
					...
					//$snapShot.append(spanStart + "&nbsp;" + content + "&nbsp;"
							//+ spanEnd);
					x='<a href="javascript:;" id="del"><img  src="images/deleteButtNewEmpty.gif" border="0"/></a>';
					...
					if (wordCount == 1) {
						...
						// src='images/1pix.gif' width='150' height='1'
						// /></div>");
						wordCount = 0;
