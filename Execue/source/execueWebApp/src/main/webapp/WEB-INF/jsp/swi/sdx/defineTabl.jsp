...
<div class="TabbedPanelsContent">
                 <s:form namespace="/swi" method="POST" action="defineTabls">
                      <table width="98%" border="0" align="center" cellpadding="2" cellspacing="0">
                        ...
                        <tr>
                          <td height="40" colspan="5" align="center"><input type="image" name="imageField" id="imageField" src="images/createNewDataSourceButton.gif" />
                            <label>
                              <input type="image" name="imageField2" id="imageField2" src="images/clearAllFields.gif">
                          </label></td>
                        </tr>
                      </table>
                    </s:form>
