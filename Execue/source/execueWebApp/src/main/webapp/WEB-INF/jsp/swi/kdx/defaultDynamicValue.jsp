...
<table border="0" cellpadding="0" cellspacing="0" width="310" align="left">
	<tr>
		<td width="15"><img name="boxTemplate_r1_c1" src="../images/boxTemplate_r1_c1.gif" width="15" height="40"
		...
		<td width="15"><a href="javascript:closeBox();" id="closeButtonId"><img name="boxTemplate_r1_c3"
			src="../images/boxTemplate_r1_c3_1.gif" width="15" height="40" border="0" id="boxTemplate_r1_c3" alt="Close"
			title="Close" /></a></td>
		<td width="13"><img src="../images/spacer.gif" width="1" height="40" border="0" alt="" /></td>
	</tr>
	<tr>
		<td background="../images/boxTemplate_r2_c1.gif"><img name="boxTemplate_r2_c1"
			src="../images/boxTemplate_r2_c1.gif" width="15" height="10" border="0" id="boxTemplate_r2_c1" alt="" /></td>
		<td width="1045" valign="top" bgcolor="#FFFFFF">
		<div id="hiddenPaneContent" style="background-color: #FFF"></div>
		</td>
		<td background="../images/boxTemplate_r2_c3.gif"><img name="boxTemplate_r2_c3"
			src="../images/boxTemplate_r2_c3.gif" width="15" height="10" border="0" id="boxTemplate_r2_c3" alt="" /></td>
		<td><img src="../images/spacer.gif" width="1" height="10" border="0" alt="" /></td>
	</tr>
	<tr>
		<td><img name="boxTemplate_r3_c1" src="../images/boxTemplate_r3_c1.gif" width="15" height="13" border="0"
			id="boxTemplate_r3_c1" alt="" /></td>
		<td background="../images/boxTemplate_r3_c2.gif" valign="top"><img name="boxTemplate_r3_c2"
			src="../images/boxTemplate_r3_c2.gif" width="25" height="13" border="0" id="boxTemplate_r3_c2" alt="" /></td>
		<td><img name="boxTemplate_r3_c3" src="../images/boxTemplate_r3_c3.gif" width="15" height="13" border="0"
													...
													<table width="100%" border="0" cellspacing="0" cellpadding="2">
														<s:iterator value="uiConcepts" id="concept" status="count">
															<tr id="conceptRow1">
																...
																<div id="loadingShowConcept1Link" style="display: none;"><img src="../images/loadingBlue.gif"
