                           ...
                           <tr >
                            ...
                            <td width="63%" align="left" valign="top"><SPAN id="assetDescription"></SPAN></td>
								...
								<tr>
									...
									<s:else>
										<td><s:hidden id="selectedAssetId"
											name="selectedAssetId" /></td>
									</s:else>
								</tr>
										...
										<tbody>
											...
											<tr>
												...
												<td width="20%"><label> <input type="radio"
													id="uploadCSV_columnNamesPresent" checked="checked"
													value="<%=PublishAssetMode.LOCAL%>" name="publishMode" /></label></td>
											</tr>
											<tr>
												<td><s:text name='execue.publishInfo.toCommunity' /> <s:text name='execue.publishInfo.toCommunity.free' /></td>
												<td><input type="radio"
													id="uploadCSV_columnNamesPresent2"
