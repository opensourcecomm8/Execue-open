...
<table width="460" border="0" cellspacing="0" cellpadding="0" style="margin-left:2px;margin-top:0px;">
  ...
  <td width="55%"  height="25" class="fieldNames">&nbsp;
     ...
     <td width="45%" align="center" class="fieldNames" ><div id="closeInnerPaneLink" ><a href="javascript:getConcept('<s:property value="concept.id"/>');" id="closeInnerPane"><s:text name='execue.businessterms.showConcept.link' /></a></div><div id="loadingCloseInnerPaneLink" style="display:none;"><img src="images/loading.gif" width="25" height="25"></div></td>
    ...
    <td width="45%" align="center" class="fieldNames" ><div id="closeInnerPaneLink" ><a href="javascript:getConcept('<s:property value="concept.id"/>');" id="<s:property value="concept.id"/>"><s:text name='execue.businessterms.showConcept.link' /></a></div><div id="loadingCloseInnerPaneLink" style="display:none;"><img src="images/loading.gif" width="25" height="25"></div></td>
  </tr>
  </s:else>
