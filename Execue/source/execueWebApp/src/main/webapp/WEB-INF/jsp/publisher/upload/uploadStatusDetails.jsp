...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <div id="requestStatusLabelLoader" style="display:none;width:60px;float:left;padding-left:10px;"><img src='../images/loading.gif' width='25' height='25' /></div>
  ...
  <tr>
    ...
    <tr>
        ...
        <td class="fieldNames" width="25%">&nbsp;</td>
        <td align="right" width="50%" ><a href="javascript:closeStatusScreen();"><img src="../images/deleteButton1.jpg" border="0" /></a></td>
      </tr>
      </table>
