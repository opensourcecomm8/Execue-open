                  ...
                  <div class="TabbedPanelsContent" style="height:267px;"><div class="tableList" style="height:267px;">
                    <table width="100%" border="0" cellspacing="0" cellpadding="2">
                      ...
                      <tr id="baseProfileRow1" class="rowSelected">
                        ...
                        <td width="85%" class="fieldNames"><div id="showBaseProfile1Link" ><a href="javascript:;" class="links" id="baseProfile1"><s:property value="%{#profile.displayName}" /></a></div><div id="loadingShowBaseProfile1Link" style="display:none;"><img src="images/loadingBlue.gif" width="20" height="20"></div></td>
                      </tr>
