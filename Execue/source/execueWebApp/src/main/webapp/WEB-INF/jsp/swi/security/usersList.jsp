					...
					<s:iterator value="users" id="user">
						<tr>
							...
							<div id="loadingShowEdit<s:property value="id"/>Link"
								style="display: none;"><img
								src="../images/loadingWhite.gif"  height="16"></div>
							</td>
							<!--td width="46"><s:if
							...
							<td width="12%"><s:if
								...
								<div id="loadingShowStatus<s:property value="id"/>Link"
								style="display: none;"><img
								src="../images/loadingWhite.gif" width="25" height="25"></div>	
							</s:else></td>
						</tr>
					</s:iterator>
				</table>
...
/*	$("#showEdit"+obj+"Link").hide(); 	
	...
	function showUserStatus(userId){
		 ...
		 if (flag){
			...
			$img.attr("src","../images/loadingBlue.gif");
