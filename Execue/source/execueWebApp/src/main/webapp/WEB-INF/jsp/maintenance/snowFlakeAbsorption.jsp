		...
		<table width="50%" border="0" align="center" cellpadding="0"
			...
			<tr>
				<td valign="top" class="descriptionText" height="70"><s:text
					name="execue.snowFlakeAbsorption.main.description" /></td>
			</tr>
			<tr>
				<td valign="top">
				...
				<table width="200" border="0" align="center" cellpadding="0"
					...
					<tr>
						...
						<div id="container" style="width: 703px; height: 205px;">
						...
						<div class="innerPane" style="width: 99%"><s:form
							id="snowFlakeAbsorptionForm" namespace="/swi"
							action="sheduleSnowFlakeAbsorptionJob" method="post">
							<table width="80%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<table width="35%" border="0" align="center" cellpadding="3"
										cellspacing="0">
										<tr> 
                                            <td width="100"><s:text name="execue.riOntoTermAbsorption.job.input.modelid" /></td>
											<td >
                                            <s:select name="selectedModelId" id="modelId"
                list="models" listKey="id" listValue="name" /> 
                                            </td>
