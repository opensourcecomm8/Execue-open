...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<table width="100%" border="0" align="left" cellpadding="0"
						...
						<tr>
							...
							<td width="75%"><s:textfield cssClass="appTextFields"
								...
								id="helpLink" title="Help" alt="Help">?</a>
						...
						<s:if test="advancedPublisher">
						  <tr>
							<td class="fieldNames" valign="top"><s:text
								name="Source type" /></td>
							<td style="padding-top: 3px;"><s:select id="appSourceTypeId"
								list="appSourceTypes" listValue="description"
								name="application.sourceType" cssClass="appTextFields"
								 /></td>
						  </tr>
						</s:if>						
						<tr>
							...
							<td style="padding-top: 3px; padding-bottom: 3px;"><s:textfield
								name="application.applicationURL" cssClass="appTextFields"
								id="appUrl" readonly="true" /></td>
						</tr>
					...
					<table align="center">
						...
						<s:else>
							...
							<tr>
								<td align="center">
								<div id="dynamicImageOuterDiv"><img id="dynamicImageDiv"
									src="../images/noImage-icon.gif" alt="not found" border="0"
									width="90"></img></div>
								</td>
							</tr>
	...
	<s:if test="uiAssetDetail.isAssetDisclaimerApplicable.value=='Y'">
    <table style="margin-top:25px;">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="4%" valign="top" style="padding-top: 2px;"><a
						...
						id="disclaimerDivImg" src="../images/bullet_toggle_plus.png"
						border="0" /></a></td>
					...
					<div id="disclaimerMessageDiv"
						style="float: right; padding-right: 30px;"></div>

					<div id="disclaimerDiv"
						style="width: 100%; height: 260px; "><s:form
						action="" id="disclaimerForm">
						<table width="50%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td><s:textarea name="uiAssetDetail.extendedDisclaimer"></s:textarea><input
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="4%" valign="top" style="padding-top: 2px;"><a
						...
						href="javascript:showForm('notesDiv');"><img id="notesDivImg"
						src="../images/bullet_toggle_plus.png" border="0" /></a></td>
					...
					<div id="notesDiv"
						...
						<table width="50%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td><s:textarea name="uiAssetDetail.extendedNote" cols="52"
									rows="5">
		...
		<table width="80%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<div id="alertMessaage" style="display: none; padding-left: 3px;"></div>
				</td>
			</tr>
			<tr>
				<td width="36%" colspan="2" style="padding-top: 10px;">
...
function showForm(name){	
	$("#"+name).slideDown();
	$("#"+name+"Img").attr("src","../images/bullet_toggle_minus.png");
	$("."+name+"Link").attr("href","javascript:closeForm('"+name+"');");	
}

function closeForm(name){	
	$("#"+name).slideUp();
	$("#"+name+"Img").attr("src","../images/bullet_toggle_plus.png");
