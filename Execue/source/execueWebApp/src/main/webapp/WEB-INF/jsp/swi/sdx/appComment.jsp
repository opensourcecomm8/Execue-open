            ...
            <tr>
              ...
              <table  border="0" cellspacing="0" cellpadding="0">
                ...
                <tr><td><span id="showLoginLinkComments"><a id="loginIdComments" class="links_sem3" href="javascript:;">Sign In</a></span> <span id="loadingShowLoginCommentsLink"
							style="display: none;padding-left:10px;padding-right:10px;"><img src="<c:out value="${basePath}"/>/WEB-INF/jsp/reporting/images/loaderTrans.gif"></span> to leave a comment</td></tr>
                  <tr>
