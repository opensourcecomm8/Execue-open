			...
			<tr>
				...
				<table width="100%" border="0" cellpadding="1" cellspacing="1"
                    ...
                    <tr id="tableGridTitle">
						...
						<td width="51%" bgcolor="#EEEEEE"><a id="sortByDescLink"
					...
					<s:iterator value="instances" status="inst" id="instance">
						<tr>
							...
							<td width="54%"><s:property value="%{#instance.description}" /></td>
							...
							<div id="showEdit1Link"><a
								...
								class="links" id="<s:property value="%{#instance.id}" />"><img src="../images/editIcon.gif"
