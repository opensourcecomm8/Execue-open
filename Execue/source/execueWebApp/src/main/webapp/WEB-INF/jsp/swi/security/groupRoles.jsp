...
<tr>
	...
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="3">
			<tr>
				<td><a href="#" id="&gt;&gt"><img
					src="../images/rightAllArrowButton.gif" width="29" height="22"
					alt="Move All to right" border="0" title="Move All to right" /></a></td>
			</tr>
			<tr>
				<td><a href="#" id="&gt"><img
					src="../images/rightArrowButton.gif" width="29" height="22"
					alt="Move to right" border="0" title="Move to right" /></a></td>
			</tr>
			<tr>
				<td><a href="#" id="&lt"><img
					src="../images/leftArrowButton.gif" width="29" height="22"
...
<tr>
	<td height="35" colspan="3" align="center"><input type="button" class="buttonSize108"
		...
		value="<s:text name='execue.role.assignRoles' />" /> <input type="button" class="buttonSize51" name="imageField2"
