...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td height="30" valign="bottom"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="29" class="titleWithBackground"><s:text name='execue.ranges.Ranges.heading' /></td>
        </tr>
      </table></td>
    </tr>
    <tr>
      ...
      <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td valign="top" class="descriptionText"><s:text name="execue.ranges.Ranges.desc" /></td>
          </tr>
        <!-- tr>
...
<div id="container" style="width:100%;height:365px;margin:auto;border-top:#CCC dashed 1px;border-bottom:#ccc dashed 1px;">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="27"><span class="tableSubHeading">Concepts</span></td>
    </tr>
    <tr>
      <td>
  ...
  <tr>
    <td height="30"  align="left" valign="top"><div id="divRanges">
										...
										<!--div id="searchTables"><a
											href="javascript:showSearch('divRanges');" class="links"><s:text
  ...
  <tr>
    <td>
     ...
     <div id="dynamicPaneConcepts"></div>
