...
<table border="0" cellpadding="0" cellspacing="0" width="195" style="margin-left:4px;">
    ...
    <tr>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><div id="divExistingKeyWordsTarget" class="tableListWithoutBorder" style="height:220px;width:190px;">
          ...
          <td align="center">
          	<div style="display: none;float:left;padding-left:40px;" id="enableDeleteSelect" >
                 <input type="button"	class="buttonSize108" 
					value="<s:text name='execue.global.deleteSelectedButton.name' />"  onclick="javascript:deleteKeywords();"/></div>
