	...
	<tr>
		...
		<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td><jsp:include page='/views/showSelectAsset.jsp' flush="true" /></td>
					</tr>
					<tr>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                  <tr>
                                    <td width="44%"><strong>Target Dataset Name:</strong></td>
                                    <td width="56%"><s:textfield cssStyle="width:180px;" name="targetAsset.name" id="targetAsset_name" /></td>
                                  </tr>
                                  <tr>
							...
							<tr>
                              ...
                              <tr>
                                <td valign="top" >&nbsp;</td>
                                <td style="padding-left:10px;"><input type="button" value="Submit" class="buttonSize51" style="margin-top: 10px;"
