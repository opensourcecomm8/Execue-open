		...
		<table width="50%" border="0" align="center" cellpadding="0"
			...
			<tr>
				<td valign="top" class="descriptionText" height="70"><s:text
					name="execue.popularityDispersion.main.description" /></td>
			</tr>
			<tr>
				<td valign="top">
				...
				<table width="200" border="0" align="center" cellpadding="0"
					...
					<tr>
						...
						<div class="innerPane" style="width: 99%"><s:form
							id="popularityDispersionForm" namespace="/swi"
							action="shedulePopularityDispersionMaintenanceJob" method="post"
