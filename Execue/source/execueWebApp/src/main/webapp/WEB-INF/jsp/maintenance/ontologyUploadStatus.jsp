		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td height="29" class="titleWithBackground"><s:text
					name="execue.ontology.main.heading" /></td>
			</tr>
		</table>
		</td>
	</tr>
	<tr>
		...
		<table width="96%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<table>
					<tr>
						<td><s:text name="execue.ontology.main.description" /></td>
						<td>
					</tr>
					<tr>
						<td valign="top">
            ...
            <div id="dynamicPaneWest">
             ...
             -->
								...
								<div class="innerPane" style="width: 99%"><s:form
									namespace="/swi" action="showOntologyUploadStatus"
									method="post">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="51%">
											...
											<table width="90%" border="0" align="center" cellpadding="3"
												...
												<!-- <tr>
													<td class="fieldNames"><strong><s:text
														name="execue.upload.main.file.name" /></strong></td>
													<td class="fieldNames"><s:property
														value="fileInfo.originalFileName" /></td>
												</tr>-->
												<!--
                    <tr>
										...
										<tr>
											...
											<s:else>
												...
												<span class="fieldNames"> <input type="submit"
													name="imageField" id="imageField" class="buttonSize108"
													value="<s:text name='execue.global.refreshStatus.button' />" /> </span> <span
													class="fieldNames"> <img
													src="../images/maintenanceHomeButton.jpg" name="imageField"
