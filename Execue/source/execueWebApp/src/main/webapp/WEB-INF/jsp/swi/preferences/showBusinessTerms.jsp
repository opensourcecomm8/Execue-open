                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="2">                    
                      <s:iterator value="businessTerms" status="inst" id="businessTerm">
			               <s:if test="#inst.even == true">
                            <tr  id="tableRow3" >				                
				                <td width="90%" colspan="2"  style="padding-left:5px;"><a href="#" onclick="showKeyword('<s:property value='%{#businessTerm.businessEntityTermDisplayName}'/>');" class="links"><s:property value="%{#businessTerm.businessEntityTermDisplayName}" /></a>
				                <div id="loadingShowConcept1Link" style="display:none;"><img src="../images/loadingBlue.gif" width="20" height="20" /></div></td>
