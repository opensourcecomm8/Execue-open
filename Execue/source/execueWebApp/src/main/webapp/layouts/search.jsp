...
<title>Semantifi : A Search Portal to publish and search datasets</title>
...
<body bgcolor="#ffffff">
<table width="100%" height="101%" border="0" cellspacing="0"  cellpadding="0">
  <tr>
  ...
  <tr>
    <td height="99%" valign="top" bgcolor="#FFFFFF"><tiles:insertAttribute name="body" /></td>
  </tr>
