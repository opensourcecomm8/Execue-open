...
<table width="350">
  ...
  <tr>
    <td><img name="button" id="login_submit" tabindex="12" style="cursor:pointer;"
			 value="Submit" onclick="processLogin()" src="<c:out value="${basePath}"/>/images/submitButton.jpg" /></td>
    <td style="padding-left:3px;"><img src="<c:out value="${basePath}"/>/images/cancelButton.jpg" style="cursor:pointer;"
