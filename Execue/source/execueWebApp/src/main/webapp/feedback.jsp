...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr >
		<td width="96%" height="25" background="images/bc-bg.jpg"  class="normalText" >
        ...
        <table width="490" border="0" align="left" cellpadding="2" cellspacing="0">
          ...
          <tr>
            ...
            <input type="image" name="imageField" id="sendFeedback"
							src="images/sendButton.jpg"/>
                            
                            <img id="button2" value="Clear" src="images/clearButton.jpg" style="cursor:pointer;" />
