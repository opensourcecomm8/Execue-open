...
package com.execue.qi.configuration.impl;
...
import com.execue.qi.configuration.IQueryInterfaceConfiguration;

public class QueryInterfaceConfigurationImpl implements IQueryInterfaceConfiguration, IConfigurable {

   public static String          NAME = "QueryInterfaceConfigurationService";
   ...
   public void setConfiguration (ExecueDBConfiguration configuration) {
