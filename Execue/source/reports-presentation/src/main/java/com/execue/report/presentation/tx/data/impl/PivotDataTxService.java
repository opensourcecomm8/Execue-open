 ...
 * @author Owner
 */
public class PivotDataTxService extends BaseDataTxService {
   ...
   public void transformData (UniversalReport universalReport) throws ReportDataTxServiceException {
      ...
      throw new ReportDataTxServiceException(PresentationExceptionCodes.DEFAULT_EXCEPTION_METHOD_NOT_SUPPORTED,
