...
public class pivotWeb extends Applet {
    ...
    String data          = "";
    String dType         = "";
    String strDtype      = "string";
    String numberDtype   = "number";
    ...
    public Component getDemoPanel(String xmlStringdata) {
        ...
        final TableModel tableModel = readXML(xmlString);
        if (tableModel == null) {
        ...
        final PivotDataModel pivotDataModel = readXMLPivotDataModel(calculatedTableModel);
         ...
         ***********************************************************************/
   private TableModel readXML(String dataString) {
           ...
           for (int cntr = 0; cntr < rowNodeList.getLength(); cntr++){      
             ...
             if (fstRowNode.getNodeType() == Node.ELEMENT_NODE){
               for (int cntrAList = 0; cntrAList < idAList.size();cntrAList++ ){
                        ...
                        else if(idDataType.equals(numberDtype)){
         ...
         ***********************************************************************/
            private PivotDataModel readXMLPivotDataModel(TableModel derivedTableModel) {
