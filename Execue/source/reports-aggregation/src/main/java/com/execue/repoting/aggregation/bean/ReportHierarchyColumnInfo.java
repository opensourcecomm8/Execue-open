...
public class ReportHierarchyColumnInfo implements Serializable {

   private BusinessAssetTerm bizAssetTerm;
   private int               level;
    ...
    */
   public void setBizAssetTerm (BusinessAssetTerm bizAssetTerm) {
