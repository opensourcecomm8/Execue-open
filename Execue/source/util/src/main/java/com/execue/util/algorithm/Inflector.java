...
public class Inflector {
    ...
    * identify word boundaries. Examples:
    * 
    * <pre>
    ...
    * delimiters into underscore. Examples:
    * 
    * <pre>
    ...
    * tokens. Like {@link #titleCase(String, String[])}, this is meant for creating pretty output. Examples:
    * 
    * <pre>
    ...
    * {@link #humanize(String, String[])}, this is meant for creating pretty output. Examples:
    * 
    * <pre>
   ...
   /**
    * Turns a non-negative number into an ordinal string used to denote the position in an ordered sequence, such as
    * 1st, 2nd, 3rd, 4th.
    * 
    * @param number
    ...
    * all other backreferences. The Java {@link Pattern regular expression processing} does not use the preprocessing
    * directives <code>\l</code>, <code>&#92;u</code>, <code>\L</code>, and <code>\U</code>. If so, such
