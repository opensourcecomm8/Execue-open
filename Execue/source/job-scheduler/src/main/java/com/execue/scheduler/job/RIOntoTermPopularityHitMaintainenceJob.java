...
public class RIOntoTermPopularityHitMaintainenceJob extends BaseLineJob {

   private static final Logger          logger = Logger.getLogger(RIOntoTermPopularityHitMaintainenceJob.class);
   ...
   protected void process (ExecueJobData jobData) throws ExecueJobSchedulerException {
      ...
      logger.debug("Invoking on updateTermsBasedOnPopularity Job [" + jobData.getJobName() + "]");
      try {
