 ...
 * @since 11/09/09
 */
public class UpdateSFLWeightBasedOnSecondaryWordJob extends BaseLineJob {

   private static final Logger    log                   = Logger
                                                                 .getLogger(UpdateSFLWeightBasedOnSecondaryWordJob.class);
   ...
   protected void process (ExecueJobData jobData) throws ExecueJobSchedulerException {
      ...
      try {
         ...
         log.debug("Invoking on updateSflTermTokenWeightBasedOnSecondaryWord Job  [" + jobData.getJobName() + "]");
         initializeDependencies();
         sflTermTokenWeightContext.setJobRequest(jobData.getJobRequest());
         kdxMaintenanceService.updateSFLTermTokensWeightBasedOnSecondaryWord(sflTermTokenWeightContext);
