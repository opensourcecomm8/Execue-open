 ...
 * @since 25/06/09
 */
public interface IDataMartCreationJobService {

   public Long scheduleMartCreationJob (MartCreationContext martCreationDetails) throws AnswersCatalogException;
