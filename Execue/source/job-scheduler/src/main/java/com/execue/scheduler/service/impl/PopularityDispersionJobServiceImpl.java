...
public class PopularityDispersionJobServiceImpl extends BaseJobService implements IPopularityDispersionJobService {

   private IExecueJobSchedulerService execueJobSchedulerService;
   private IJobDataService            jobDataService;

   public Long schedulePopularityDispersionJob (PopularityRestorationContext popularityRestorationContext)
            throws SWIException {
      JobRequest jobRequest = null;
      try {
         ExecueJobData jobData = new ExecueJobData();
         populateJobData(jobData, JobType.POPULARITY_DISPERSION);
         XStream xStream = new XStream();
         String popularityDispersionInputXML = xStream.toXML(popularityRestorationContext);
         ...
         jobRequest = ExecueBeanManagementUtil
                  .prepareJobRequest(JobType.POPULARITY_DISPERSION, popularityDispersionInputXML, JobStatus.PENDING,
         ...
         throw new KDXException(SWIExceptionCodes.POPULARITY_DISPERSION_JOB_SCHEDULING_FAILURE_CODE, e);
