...
public class PopularityCollectionJob extends BaseLineJob {

   private static final Logger          logger = Logger.getLogger(PopularityCollectionJob.class);
   private IPopularityCollectionService popularityCollectionService;
   ...
   protected void process (ExecueJobData jobData) throws ExecueJobSchedulerException {
      ...
      logger.debug("Invoking PopularityCollection Job [" + jobData.getJobName() + "]");
      try {
         initializeDependencies();
         popularityRestorationContext.setJobRequest(jobData.getJobRequest());
         popularityCollectionService.collectPopularityInfo(popularityRestorationContext);
   ...
   private void initializeDependencies () throws Exception {
      popularityCollectionService = (IPopularityCollectionService) SpringContextHolder
               .getBean("popularityCollectionService");
   }
