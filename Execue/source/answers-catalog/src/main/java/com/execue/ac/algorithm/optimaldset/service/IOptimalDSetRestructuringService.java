 ...
 * @since 18/02/2012
 */
public interface IOptimalDSetRestructuringService {

   public List<OptimalDSetCandidateDimensionPattern> restructurePatterns (
            List<OptimalDSetCandidateDimensionPattern> levelPatterns,
            OptimalDSetLevelInputInfo optimalDSetLevelInputInfo) throws AnswersCatalogException;
}
