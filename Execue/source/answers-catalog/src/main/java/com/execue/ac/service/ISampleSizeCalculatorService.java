...
/**
 * This service contains the sampling algorithm.It tells the percentage of the records to be picked for sample.
 * 
 * @author Vishay
 * @version 1.0
 * @since 11/01/2011
 */
public interface ISampleSizeCalculatorService {
