...
/**
 * This bean contains the information from each step of mart updation so that other steps can use it.
 * 
 * @author Vishay
 * @version 1.0
 * @since 11/01/2011
 */
public class MartUpdationOutputInfo {

   private MartUpdationInputInfo                         martUpdationInputInfo;
   ...
   public MartUpdationInputInfo getMartUpdationInputInfo () {
      return martUpdationInputInfo;
   }

   public void setMartUpdationInputInfo (MartUpdationInputInfo martUpdationInputInfo) {
      this.martUpdationInputInfo = martUpdationInputInfo;
   }
