...
/**
 * This is service in NLPEngine used for get BusinessQuery and its components from ReducedForm
 * 
 * @author kaliki
 */

public interface IReducedFormBusinessQueryGenerator {
   ...
   // public BusinessQuery generate (SemanticPossibility reducedForm) throws NLPException;
}
