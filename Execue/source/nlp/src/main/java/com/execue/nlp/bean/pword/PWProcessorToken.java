 ...
 * @author kaliki
 */
public class PWProcessorToken {

   private NLPToken token;

   public PWProcessorToken (NLPToken token) {
      this.token = token;
   }
   ...
   public String getWord () {
      return TokenUtility.getCurrentWordValue(token);
   }

   public int getPostion () {
      return token.getDefaultRecognitionEntity().getPosition();
   }
}
