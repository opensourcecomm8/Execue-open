...
public abstract class IndividualRecognitionProcessor extends RecognitionProcessor {

   @Override
   protected boolean isValidForExecution (Summary input) {
      return input.getStatus().equals(PossibilityStatus.INDIVIDUAL_RECOGNITION);
   }
}
