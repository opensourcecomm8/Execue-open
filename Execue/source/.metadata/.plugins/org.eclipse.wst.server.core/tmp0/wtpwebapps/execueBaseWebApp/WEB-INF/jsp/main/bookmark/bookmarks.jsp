...
<link rel="stylesheet" href="<c:out value="${basePath}"/>/css/main/jquery.treeview.css" type="text/css"
	media="screen" />
...
<div style="width: 200px; height: 60px;"><s:form id="form1"
 method="post">
					...
					<table width="100%">
						<tr>
							...
							<s:a href="#" id="createNewFolder">
                                ...
                                <img src="<c:out value="${basePath}"/>/images/main/newFolderButton.jpg" border="0"   />
							</s:a>
  ...
  <tr>
    <td><img  src="<c:out value="${basePath}"/>/images/main/doneButton.jpg" name="createBookmark" id="bookmarkID" style="width:57px;margin-right:5px" /></td>
    <td><img src="<c:out value="${basePath}"/>/images/main/closeNewButton.jpg"  name="closeButtonId"  value="Cancel" id="closeButtonId" onclick="javascript:$('#hiddenPane').fadeOut('slow');" /></td>
  </tr>
</table>
</td>
		</tr>
