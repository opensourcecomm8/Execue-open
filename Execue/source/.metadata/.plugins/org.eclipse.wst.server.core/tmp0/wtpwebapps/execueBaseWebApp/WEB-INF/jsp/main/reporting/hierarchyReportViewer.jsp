...
$(document).ready(function () {
    ...
    showRecordsDiv();
    // loading Hierarchy grid
	chartView("hierarchyReportGrid");
});
...
function chartView(chartName){
  // $("#"+chartName).empty().html('<div id="pleaseWaitDiv" style="margin: 100px 200px; width: 110px;"><img id="waiting_img" src="images/main/Loader-main-page-3.gif" width="32" height="32" /></div>');
   $.get("showHierarchyReportGrid.action?agQueryIdList=<%=request.getParameter("agQueryIdList")%>&hierarchySummaryId=<%=request.getParameter("hierarchySummaryId")%>&source=<%=request.getParameter("source")%>&title=<%=request.getParameter("title")%>&requestedString=<%=request.getParameter("requestedString")%>&applicationId=<%=request.getParameter("applicationId")%>&verticalId=<%=request.getParameter("verticalId")%>", function (data) {      
                            ...
                            <td width="52%" height="20" align="center"><!-- sub links starts -->
                             <div style="height:16px;padding-top:2px;z-index:20;position:absolute;" id="waitImage"><div id="pleaseWaitDiv" style="display: none; margin: auto; width: 110px;">
								<img id="waiting_img" src="images/main/Loader-main-page-3.gif" width="22" height="22" />
                                    ...
                                    <td width="30%" align="right"><div id="showWelcome" style="padding-right:20px;color:#333;font-size:14px;padding-top:0px;font-family:'Trebuchet MS', Arial, Helvetica, sans-serif;text-align:right;width:300px;float:right;">
   </div></td>
  ...
  <tr>
	...
	<tr>
		<td height="auto" valign="top">
			<div id="hierarchyReport"><!--<s:property value="htmlOutput" id="htmlOutput" escape="html" />--><div id="hierarchyReportGrid"></div></div>
		</td>
	</tr>
</table>
