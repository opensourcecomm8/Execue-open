...
<div class="tableList"
                            ...
                            <tr  id="tableRow3" >				                
				                <td width="90%" colspan="2"  style="padding-left:5px;">				              
				                  <s:if test='businessEntityTermType.value=="I" || businessEntityTermType.value=="IP"'>
				                   <a href="#" onclick="showKeyword('<s:property value='%{#businessTerm.businessEntityTermDisplayName}'/>');" class="links"><s:property value="%{#businessTerm.businessEntityTermDisplayName}" /></a>(<s:property value="%{#businessTerm.parentBusinessEntityTermDisplayName}"/>)
				                  </s:if>
				                  <s:else>
				                    <a href="#" onclick="showKeyword('<s:property value='%{#businessTerm.businessEntityTermDisplayName}'/>');" class="links"><s:property value="%{#businessTerm.businessEntityTermDisplayName}" /></a>
				                  </s:else>
                    ...
                    <div id="paginationDiv2" style="margin-top:10px;margin-bottom:5px;" ><pg:page targetURL="showBTforParallelWords.action?businessEntityTermType=${businessEntityTermType}" targetPane="dynamicPaneBTerms"/></div>
