...
<table width="100%" border="0" align="center" cellpadding="0"
    ...
    <tr>
        ...
        <table width="100%" border="0" align="center" cellpadding="0"
            cellspacing="0">
            <tr>
                <td colspan="3" valign="top" class="descriptionText"><s:text name="execue.assetAnalysisReport.main.defaultMetric.description"></s:text> </td>
            </tr>
             <tr>
				<td valign="top" class="descriptionText"><a href='showDefaultMetrics.action?sourceURL=showAssetAnalysisReport.action?selectedAssetId=<s:property value="selectedAssetId"/>'>Define Default Metrics</a></td>
			</tr>
            <tr>
            ...
            <tr>
                ...
                <td width="98%" valign="top">
                 ...
                 <div id="defaultMetricReportDiv" style="width:705px;height:310px;overflow:auto;margin:20px;border:solid 1px #ccc"> 
				...
				<s:iterator value="assetAnalysisReportInfo.assetAnalysisTablesInfo" id="assetAnalysisTablesList" >
                    <tr>
                       ...
                       <div style="width:600px;"><div class="tableName" style="width:20px;float:left;" > <img src="../images/admin/bullet_toggle_plus.png" /></div><div  style="width:auto;float:left;"> <s:property value="operationTable.name" /></div>
