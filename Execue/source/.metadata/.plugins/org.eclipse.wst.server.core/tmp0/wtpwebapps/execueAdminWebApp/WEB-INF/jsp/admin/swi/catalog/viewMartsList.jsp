				...
				<table width="100%" cellspacing="1" cellpadding="0" border="0" id="tableGridMemberInfo">                    
                    <tbody><tr id="tableGridTitle">
					 ...
					 <s:iterator value="marts">			   
                     		<tr>
								...
								<div id='showEdit1Link_<s:property value="id"/>'><a id="1" class="links" href="javascript:editMart('<s:property value="id"/>');"><img height="16" border="0" title="Edit Record" alt="Edit Record" src="../images/admin/editIcon.gif"></a></div>
				   ...
				   <table>
				       <tr>
						  ...
						  <td width="11%"><s:text name="execue.mart.empty.list"></s:text></td>
						</tr>
						</table>
				   </s:else>   
	<script>
	function editMart(assetId){	  
	    $("#showEdit1Link_"+assetId).hide();
	    $("#loadingShowEdit1Link_"+assetId).show();
		window.location="editMart.action?existingAssetId="+assetId;
	}
	</script>