	...
	<tr>
		...
		<table width="98%" border="0" align="center" cellpadding="5"
			...
			<tr>
				<td valign="top" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr><td><div id="addNewCubeLink"><a id="addNewCube" class="arrowBg" href="showCubeRequest.action"><s:text name="execue.cube.creation.request.link"></s:text></a></div></td></tr>
  <tr>
			...
			<tr>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<div id="dynamicPane">
							<jsp:include page='viewCubesList.jsp' flush="true" />
						</div>
						</td>
					</tr>
					<tr>
