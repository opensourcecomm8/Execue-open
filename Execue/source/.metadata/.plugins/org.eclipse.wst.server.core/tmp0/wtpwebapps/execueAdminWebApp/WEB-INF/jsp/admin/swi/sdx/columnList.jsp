...
<s:form id="columnListForm">
	...
	<table width='auto' border="0" cellspacing="0" cellpadding="0">
		<tr>
			...
			<table width="auto" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<div
						style="width: 990px; height: 200px; overflow: hidden; overflow-x: hidden; position: relative; border: 1px;"
						id="collist">
					<table width='auto' border="0" cellspacing="0" cellpadding="0"
						id="tableGrid">
						<tr>
        ...
        <td><input type=text name='unit select' value='unit select'></td>-->
						...
						--%>
								<td><s:if test="table.lookupType.value != 'NONE'">
        ...
        <td><input type="text" id="subListForColumnInfo<s:property value="#even_odd.index"/>Unit" name="subListForColumnInfo[<s:property value="#even_odd.index"/>].unit" value="<s:property value="unit"/>"/></td>-->
								...
								<div style="display: inline; white-space: nowrap; width: 180px;"><span
									...
									src="../images/admin/buttonSmall.jpg" style="cursor:pointer;" title="Click to Edit Data Format" alt="Click to Edit Data Format"
								...
								<div style="display: inline; white-space: nowrap; width: 180px;"><span
									...
									src="../images/admin/buttonSmall.jpg"
...
<s:hidden name="searchType" id="columnSearchTypeId"/>
<s:hidden name="searchString" id="columnSearchStringId"/>

<script>
$("#divSearchColumn").searchRecordsComponent({actionName:"../swi/getSubColumnsInfo.action?paginationType=column",targetDivName:"columnIno"});
