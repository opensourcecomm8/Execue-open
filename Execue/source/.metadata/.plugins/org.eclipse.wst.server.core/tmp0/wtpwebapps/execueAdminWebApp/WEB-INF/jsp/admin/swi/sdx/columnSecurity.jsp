...
<table width="100%" border="0" align="left" cellpadding="0"
	...
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td height="29" class="titleWithBackground"><s:text name="execue.column.security.level"/></td>
			</tr>
		</table>
		</td>
	</tr>
	<tr>
		...
		<table width="98%" border="0" align="center" cellpadding="0"
			cellspacing="0">
			<tr>
				<td valign="top" class="descriptionText" width="70%"><s:text name="execue.column.security.description"/></td>
			</tr>
			<tr>
...
<s:hidden name="" value="Column" id="contextId"></s:hidden>
</body>
</html>