...
<div class="tableList"
                                        ...
                                        <s:hidden id="baseAssetId" name="baseAsset.id" value="%{baseAsset.id}" />
                                         <div id="paginationDiv2" style="margin-top:10px;margin-bottom:5px;" ><pg:page targetPane="dynamicPaneCubeConcepts" targetURL="showConceptsForCube.action?baseAsset.id=${baseAsset.id}"/></div>