...
<style>
.top-bg {
	background-image: url(images/admin/results_header_bg.jpg);
...
.technology-1 {
	background-image: url(images/admin/top-bg-inner-2.png);
	background-repeat: repeat-x;
...
<div style="margin:auto;width:91%">
                          ...
                          <tr>
                            <td width="43%" height="20" align="right"><!-- sub links starts -->
                              ...
                              <div style="height:16px;padding-top:2px;z-index:20;position:absolute;" id="waitImage"><div id="pleaseWaitDiv" style="display: none; margin: auto; width: 110px;">
								<img id="waiting_img" src="images/admin/Loader-main-page-3.gif" width="22" height="22" />
							</div>
                        </div></td>
  ...
  <span id="loadingShowLoginLink" style="display: none;"><img
   src="images/admin/loaderTrans.gif" ></span>
  ...
  <tr >
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="8%" valign="top"><div style="padding-top:10px;padding-left:0px;padding-right:0px;padding-bottom:1px;"><a href="<c:out value='${mainPath}' />/index.jsp"><img name="index_r1_c1" src="images/admin/inner-page-logo.png" border="0"
					id="index_r1_c1" alt="" /></a></div></td>
    <td width="92%" align="left"> 
    <!--<jsp:include page="main/freeFormSearch.jsp"  flush="true" />-->
    </td>
  </tr>
</table>
</div>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr >
		<td width="96%" height="25" background="images/admin/bc-bg.jpg"  class="normalText" >
...
<s:text name="execue.feedback.leftPaneContent.text" />
        ...
        <table width="490" border="0" align="left" cellpadding="2" cellspacing="0">
          ...
          <tr>
            ...
            <input type="image" name="imageField" id="sendFeedback"
							src="images/admin/sendButton.jpg"/>
                            
                            <img id="button2" value="Clear" src="images/admin/clearButton.jpg" style="cursor:pointer;" />
  ...
  <tr>
    <td><jsp:include page="views/footer-search.jsp" flush="true" /></td>
  </tr>
</table>
<script>
