...
<script src="../js/admin/ranges-jq.js" type="text/javascript" ></script>
...
<table id="rangeDefinition" width="100%">
  <thead>
    ...
    <td width="70%" height="40" ><strong><s:text name='execue.ranges.Range.heading' /></strong>
      ...
      <tr>    
      <td class="fieldNames"><strong><s:text name='execue.ranges.conceptName.text' /></strong> <s:property value = "conceptName" id="conceptName"/></td>
    </tr>
    <tr>
     <s:if test="range.enabled == true">
      <td class="fieldNames" colspan="2">
      <strong><s:text name="execue.ranges.status.enabled"/> :</strong>
    ...
    <tr align = "center">
      ...
      <s:if test="range.id != null">
      		<span id="enableUpdateRange"> <input type="button" class="buttonSize108" value="<s:text name='execue.ranges.updateRange.button' />" onclick="javascript: updateRange();"></span>
        			<span id="updateProcess" style="display:none"><img src="../images/admin/loadingWhite.gif" hspace="3" vspace="5" />
    		</span>
      </s:if>
      <s:else>
