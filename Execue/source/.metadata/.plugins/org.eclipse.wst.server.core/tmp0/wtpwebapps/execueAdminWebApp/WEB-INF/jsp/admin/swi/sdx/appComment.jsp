            ...
            <tr>
              ...
              <table  border="0" cellspacing="0" cellpadding="0">
                ...
                <tr><td><span id="showLoginLinkComments"><a id="loginIdComments" class="links_sem3" href="javascript:;">Sign In</a></span> <span id="loadingShowLoginCommentsLink"
							style="display: none;padding-left:10px;padding-right:10px;"><img src="<c:out value="${basePath}"/>/WEB-INF/jsp/reporting/images/admin/loaderTrans.gif"></span> to leave a comment</td></tr>
                  <tr>
                    <td height="20" align="left" class="Arial11Blue">Don't have a Login Id?  <a href="<c:out value="${basePath}"/>/WEB-INF/jsp/reporting/biSignUp.action">Sign Up</a></td>
                  </tr>
