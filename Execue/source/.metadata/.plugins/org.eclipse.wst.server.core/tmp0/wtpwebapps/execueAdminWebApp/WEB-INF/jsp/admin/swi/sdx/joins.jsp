...
<table width="100%" border="0" align="center" cellpadding="0"
	...
	<tr>
		...
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<!-- tr>
          <td valign="top" background="../images/admin/blueLine.jpg"><img src="../images/admin/blueLine.jpg" width="10" height="1" /></td>
          </tr -->
			<tr>
				<td valign="top">
								...
								<table width="99%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										...
										<div id="divJoinsTable" class="tableListWithoutBorder"
											...
											<IMG class=folderImage src="../images/admin/tableIcon.jpg" width="20" > <SPAN
												class=tableHolder><s:property value="tableDisplayName" /></SPAN></div>
                                                <div style='width:180px;'><img src='../images/admin/1pix.gif' width='180' height='1' border='0' /></div>
                                                </td> </tr>
                                                </s:if>
										</s:iterator>
                                         </table>
								...
								<table width="100%" border="0" align="center" cellpadding="3"
									...
									<tr>
										...
										<!--<span id="saveProcess" style="display: none"><img
											...
											src="../images/admin/saveSelectedJoins_disabled.gif" /></span>-->
