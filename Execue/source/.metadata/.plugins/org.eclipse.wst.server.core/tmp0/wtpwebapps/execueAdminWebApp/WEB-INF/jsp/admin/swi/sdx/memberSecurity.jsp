...
<table width="100%" border="0" align="left" cellpadding="0"
	...
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td height="29" class="titleWithBackground"><s:text name="execue.member.security.level"></s:text> </td>
			</tr>
		</table>
	...
	<tr>
		...
		<table width="98%" border="0" align="center" cellpadding="0"
			cellspacing="0">
			<tr>
				<td valign="top" class="descriptionText" width="70%"><s:text name="execue.member.security.description"></s:text></td>
			</tr>
			<tr>
		      ...
		      <table width="300" border="0" cellspacing="0" cellpadding="0"
					align="right">
					<tr>
						<td height="35"><span style="white-space: nowrap"><s:text name="execue.select.table.level"/></span></td>
						<td align="center" style="padding-left: 3px;"><select
							id="selectTableId" name="selectedTableId"
							style="width: 120px;">							
						</select></td>
					</tr>
				</table>
...
<s:hidden name="" value="Member" id="contextId"></s:hidden>
</body>
</html>