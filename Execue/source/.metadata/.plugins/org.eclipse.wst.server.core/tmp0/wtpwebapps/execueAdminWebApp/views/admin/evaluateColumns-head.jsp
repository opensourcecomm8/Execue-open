...
<script src="../js/common/jquery.ui.all.js" language="JavaScript" /></script>
...
<script src="../js/admin/jquery.json.min.js" type="text/javascript"></script>
<script src="../js/admin/jquery.execue.UIPublishedFileTable.js" type="text/javascript"></script>
