...
insert into `data_source` (`id`,`name`,`description`,`provider`,`conn_type`,`jndi_name`,`user_name`,`password`,`password_encrypted`,`location`,`port`,`schema_name`,`owner`,`jndi_conn_factory`,`jndi_provider_url`,`type`,`display_name`)
select 2,'uploaded','uploaded',`provider`,`conn_type`,`jndi_name`,`user_name`,`password`,`password_encrypted`,`location`,`port`,`schema_name`,`owner`,`jndi_conn_factory`,`jndi_provider_url`,'UPLOADED','Uploaded' 
