...
<tr>
     ...
     src="images/quinnox/boxTemplate_r1_c1.gif" width="15" height="40"
     border="0" id="boxTemplate_r1_c1" alt="" /></td>
          <td background="images/quinnox/boxTemplate_r1_c2.gif"><img
     name="boxTemplate_r1_c2" src="images/main/spacer.gif"
     width="279" height="40" border="0" id="boxTemplate_r1_c2" alt=""/></td>
          <td width="15"><img
     name="boxTemplate_r1_c3" src="images/quinnox/boxTemplate_r1_c3.gif"
