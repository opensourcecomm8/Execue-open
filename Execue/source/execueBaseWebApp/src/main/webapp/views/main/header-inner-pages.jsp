...
<style>
.login_bg {
	background-image: url(../../images/main/login_r2_c1.jpg);
}
        ...
        <td colspan="2" align="center" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="innerPages-bgColor">
          <tr>
            ...
            <table width="916" border="0" align="center" cellpadding="0" cellspacing="0" id="logoTable">
              <tr>
                <td width="20%" height="50" align="left" valign="middle"><a href="../index.html"><img src="../images/main/semantifi3bnew/inner-page-logo.png" width="112" height="30" vspace="10" border="0" /></a></td>
