...
<link rel="stylesheet" href="css/main/ui.theme.css" type="text/css" media="screen" />
<link rel="stylesheet" href="css/main/jquery-ui-daterangepicker.css" type="text/css" media="screen" />
</HEAD>
...
<script type="text/javascript" language="JavaScript" src="js/main/qi/XMLWriter.js"></script>
<script  type="text/javascript" language="JavaScript" src="js/main/qi/qiSuggestTerm.js"></script>
<script type="text/javascript" language="JavaScript" src="js/main/qi/qiSuggestCondition.js"></script>
<script type="text/javascript" language="JavaScript" src="js/main/qi/qiSuggestTB.js"></script>
<script  type="text/javascript" language="JavaScript" src="js/common/mm_menu.js"></script>
<script  type="text/javascript" src="js/main/jquery-ui.min.js"></script>
<script type="text/javascript" src="js/main/daterangepicker.jQuery.js"></script>
...
function submitData() {
	...
	setTimeout('document.images["waiting_img"].src = "images/main/wait.gif"', 200); 
	return true;
}
...
$("#showQS").hide();
	...
	if($('#ss_metrics').text()== '' && $('#ss_population').text() == '' && $('#ss_TB').text() == ''
		...
		$('#query').show();
		$("#qs").show();
		$("#toggleSnapshot").attr("src","images/main/toggle_close1.jpg");
	}
...
if($imgName=="images/main/c1_qi_advanced_options.gif"){	
	showAll();
	$ht=$("#showAll").height()+25;
	$("#showAllContainer .divBorderWhite").css("height",$ht+"px");
	$(this).attr("src","images/main/c2_qi_advanced_options.gif");
}
if($imgName=="images/main/c2_qi_advanced_options.gif"){	
	showOptions('business_metrics');
	$(this).attr("src","images/main/c1_qi_advanced_options.gif");
	$("#showAllContainer").hide();
}
	});
*/
...
$imgName=	$(this).attr("src");								
		if($imgName=="images/main/toggle_show1.jpg"){							
			showQuerySnapShot();
			$("#qs").show();
			$(this).attr("src","images/main/toggle_close1.jpg");
		}
		if($imgName=="images/main/toggle_close1.jpg"){							
			$("#qs").hide();
			$(this).attr("src","images/main/toggle_show1.jpg");
		}
});
...
$imgName=	$(this).attr("src");								
		if($imgName=="images/main/toggle_show.jpg"){							
			$("#cohortToggleDiv").show();
			$("#showAllContainer .divBorderWhite").css("height","360px")
			$(this).attr("src","images/main/toggle_close.jpg");
		}
		if($imgName=="images/main/toggle_close.jpg"){							
			$("#cohortToggleDiv").hide();
			$("#showAllContainer .divBorderWhite").css("height","260px")
			$(this).attr("src","images/main/toggle_show.jpg");
		}
...
function showApplications(){ 
   ...
   var qiJSONString='<c:out value="${qiJSONString}"/>'; 
	$.get("qi/showCommunityApplicationsIncludingUserSpecificApps.action?type=QI",function(data){	
		$("#selectApp").empty().append(data);
		if(appid){
		  $("#selectApp option[value='"+appid+"']").attr("selected",true);		
		  $("#selectApp option[value='"+appid+"']").change();		
		}	
		if(qiJSONString){
		   qiJSONString=qiJSONString.replace(/&#034;/g, "'");
		   var obj = eval("(" + qiJSONString + ")");
		   displayJSONData(obj);
      }	
	});
