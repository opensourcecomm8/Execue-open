                            ...
                            <td width="41%" height="20" align="right"><!-- sub links starts -->
                              ...
                              <div style="height:16px;padding-top:2px;z-index:20;position:absolute;" id="waitImage"><div id="pleaseWaitDiv" style="display: none; margin: auto; width: 110px;">
								<img id="waiting_img" src="images/main/Loader-main-page-3.gif" width="22" height="22" />
                                    ...
                                    <td width="40%" align="right"><div id="showWelcome" style="padding-right:20px;color:#333;padding-top:0px;font-size:14px;font-family:'Trebuchet MS', Arial, Helvetica, sans-serif;text-align:right;width:200px;float:right;">
   </div></td>
            ...
            for(int i=0;i<chartType.length;i++){
              ...
              try{
                ...
                if(chartType[i].equals("1")){ 
                   ...
                   %>
                  <img id="gridIcon"  class="activeIcon" style="height:60px;width:80px;border-width:0px; margin-top: 7px;" src="images/main/reporting/ngrid.png" onclick="chartView('<%=id%>');" onmouseover="chartView('<%=id%>');" />
                  <% 
                  continue;
				 }
                else if(chartType[i].equals("4_NOTUSED"))
                {
                   id = "PivotTable";
             %>
                  <img id="pivotTable1" class="activeIcon"  style="height:60px;width:80px;border-width:0px; margin-top: 7px;" src="images/main/reporting/pivot.png" onclick="chartView('<%=id%>');" onmouseover="chartView('<%=id%>');" />
                  <%    
                   continue;
                }  
                 ...
                 //------- GroupBYGrid
                    ...
                    id = "GroupBYGrid";
             %>
                  <img id="groupGridIcon"  class="activeIcon" style="height:60px;width:80px;border-width:0px; margin-top: 7px;" src="images/main/reporting/groupgrid.png" onclick="chartView('<%=id%>');" onmouseover="chartView('<%=id%>');" />
                  <%
                    continue;
                 }
                 //------- AcrossGrid
                    ...
                    id = "AcrossGrid";
             %>
                  <img id="acrossGridIcon"  class="activeIcon" style="height:60px;width:80px;border-width:0px; margin-top: 7px;" src="images/main/reporting/acrossgrid.png" onclick="chartView('<%=id%>');" onmouseover="chartView('<%=id%>');" />
                  <%
                    continue;
                 }  
                //------- LinesChart                        
        ...
        %>
               ...
               if(formBeans.getDetailReport() != null && formBeans.getDetailReport().length() > 1){ 
                ...
                %> <img id="detailGridIcon" class="activeIcon"
   					...
   					src="images/main/reporting/detailedgrid.png" onclick="chartView('<%=id%>');"
                ...
                %> <img id="detailGridIcon" class="activeIcon"
   					style="height: 60px; width: 80px; border-width: 0px; margin-top: 7px;"
   					src="images/main/reporting/detailedgtable.jpg" onclick="chartView('<%=id%>');"
   					onmouseover="chartView('<%=id%>');" /> <% 
   					tempId = tempId +",DetailReport";
   			 }
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <%    			
         ...
         %>
         	<a class="sharing-button" addthis:title="<%=request.getParameter("title")%>"
				addthis:url="&reportType=<%=chartType[i]%>"><img src="images/main/share1.jpg"  alt="Bookmark and Share" style="border:0"/></a>
  </div>
  <%   
            continue;
            }
  ...
  <div id="multiBarChart" class="<%=classType%>" align="center" style="margin-top: 15px">
    <%
            ...
            %><div>
            <a class="sharing-button" addthis:title="<%=request.getParameter("title")%>"
				addthis:url="&reportType=<%=chartType[i]%>"><img src="images/main/share1.jpg"  alt="Bookmark and Share" style="border:0"/></a></div>
  </div>
  <%      
             } 
             else if(chartType[i].equals("7")){
  ...
  <div id="ClusterBarChart" class="<%=classType%>" align="center" style="margin-top: 15px">
    ...
    <table border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="28"><img name="reportTable_r1_c1" src="images/main/reportTable_r1_c1.jpg" width="28" height="23" border="0" id="reportTable_r1_c1" alt="" /></td>
        <td background="images/main/reportTable_r1_c2.jpg"><img name="reportTable_r1_c2" src="images/main/reportTable_r1_c2.jpg" width="100" height="23" border="0" id="reportTable_r1_c2" alt="" /></td>
        <td width="29"><img name="reportTable_r1_c3" src="images/main/reportTable_r1_c3.jpg" width="29" height="23" border="0" id="reportTable_r1_c3" alt="" /></td>
      </tr>
      <tr>
        <td background="images/main/reportTable_r2_c1.jpg"><img name="reportTable_r2_c1" src="images/main/reportTable_r2_c1.jpg" width="28" height="50" border="0" id="reportTable_r2_c1" alt="" /></td>
        <td width="100" height="50"><!--Content starts -->
          ...
          <!--Content ends  --></td>
        <td background="images/main/reportTable_r2_c3.jpg"><img name="reportTable_r2_c3" src="images/main/reportTable_r2_c3.jpg" width="29" height="50" border="0" id="reportTable_r2_c3" alt="" /></td>
      </tr>
      <tr>
        <td><img name="reportTable_r3_c1" src="images/main/reportTable_r3_c1.jpg" width="28" height="26" border="0" id="reportTable_r3_c1" alt="" /></td>
        <td background="images/main/reportTable_r3_c2.jpg"><img name="reportTable_r3_c2" src="images/main/reportTable_r3_c2.jpg" width="100" height="26" border="0" id="reportTable_r3_c2" alt="" /></td>
        <td><img name="reportTable_r3_c3" src="images/main/reportTable_r3_c3.jpg" width="29" height="26" border="0" id="reportTable_r3_c3" alt="" /></td>
      </tr>
    </table>
    <!--Table ends  -->
    <%	}catch(Exception e){
          		...
          		<div id="DetailReport" class="<%= classType %>" align="center"
      				...
      				<%}
          		           ...
          		           if(!messageFlag){
      		    			%>
      		    			<a class="sharing-button" addthis:title="<%=request.getParameter("title")%>"
      						addthis:url="&reportType=0"><img src="images/main/share1.jpg"  alt="Bookmark and Share" style="border:0"/></a>
      						<%} %>
          		</div>
          		<%   
                 }
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td height="25" colspan="2" align="center"
			background="images/main/bc-bg.jpg" valign="top">&nbsp;</td>
	</tr>
