...
.top-bg {
	background-image: url(images/quinnox/header_top.png);
                            ...
                            <td width="52%" height="20" align="center"><!-- sub links starts -->
                             <div style="height:16px;padding-top:2px;z-index:20;position:absolute;" id="waitImage"><div id="pleaseWaitDiv" style="display: none; margin: auto; width: 110px;">
								<img id="waiting_img" src="images/main/Loader-main-page-3.gif" width="22" height="22" />
                                    ...
                                    <td width="30%" align="right"><div id="showWelcome" style="padding-right:20px;font-size:14px;color:#333;padding-top:0px;font-family:'Trebuchet MS', Arial, Helvetica, sans-serif;text-align:right;width:300px;float:right;">
   </div></td>
...
<table align="center">
  ...
  <tr>
    ...
    <td align="center" width="60"  valign="top" height="30" style="padding-top:6px;"> 
        <a class="downloadExcelLink" href='showCSV.action?agQueryIdList=<s:property value="agQueryId"/>&title=<%=request.getParameter("title")%>
