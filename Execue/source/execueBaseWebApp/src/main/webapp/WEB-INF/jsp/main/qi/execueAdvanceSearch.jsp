...
td.top-bg a:hover,a#adminId:hover:hover{
	color:#3C71A1; 
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="3"
					...
					<tr>
						...
						<div id="showWelcome"
							style="padding-right: 20px; color: #333; padding-top: 0px; padding-right: 18px;font-size:14px; font-family: 'Trebuchet MS', Arial, Helvetica, sans-serif; text-align: right; width: 500px; margin: auto;">
						</div>
						</td>
                       ...
                       <!--  <td width="1%" id="publisherTdSeperator" style="display:none;padding-left:10px;padding-right:10px;" >|</td>-->
						...
						<td width="2%" id="seperatorId" style="padding-left:10px;padding-right:10px;display:none;">|</td>
						<td width="6%" " style="white-space: nowrap;"><span
							id="showLoginLink" style="padding-left: 3px;color:#FF9505;"><a
							href="javascript:;" class="links_sem3" id="loginId"><s:text
							name="execue.login.link" /></a> <a
							href="<c:url value='/j_spring_security_logout'/>"
							class="links_sem3" id="logoutId" style="display: none;color:#FF9505;"><s:text
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<div
					...
					name="index_r1_c1" src="images/main/inner-page-logo.png" border="0"
...
<table width="806" border="0" align="center" cellpadding="2"
	...
	<tr>
		...
		<select id="selectApp" style='height: 22px; font-size: 14px; color: #525252; margin-top: 2px;'>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
			...
			<tr>
				...
				<table width="96%" border="0" align="center" cellpadding="0"
					...
					<tr>
						...
						<div id="divcontainer" style="background: url(images/quinnox/qi_bg2.jpg) repeat-x " >
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <!--div class="search_header_text_qi_metrics" style="width: 530px"><span
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
  <td width="2"><img src='images/main/1pix.gif' width='10' height='1' /></td>
    <td width="530"><div id="selectMetrics"	style="padding-top: 0px; float: left; padding-left: 0px; display: none;"></div></td>
    <td align="left" valign="top"><div id="search_image" style="margin-left:5px;"><input type="image" 
							id="searchBtn" src="images/quinnox/qi_search.jpg" alt="Search" title="Search" tabindex="-1" width="90" height="27" /></div></td>
  </tr>
  <tr>
  <td width="2"><img src='images/main/1pix.gif' width='10' height='1' /></td>
  ...
  <tr>
    ...
    <td  align="left"><span class="smallTextBlack" ><s:text name="execue.condition.example" /></span></td>
              ...
              <!-- advanced option condition  ends -->
               ...
               <div class="search_header" id="moreDiv" style="display:none;padding-bottom:3px;"><div style="width:17px;float:left;"><img src="images/main/toggle_show.jpg" vspace="3" alt="More Options" title="More Options" id="toggleMore"></div><div class="cohort_heading" id="more" style="width:600px;"><strong>More...</strong></div></div>
  ...
  <tr>
   <td width="535"><div id="advOpt_summarize" style="width:530px;"> </div></td> <td width="100"><div class="smallTextBlack" style="width:150px"><s:text name="execue.summerize.example" /></div></td>
              ...
              <div id="cohort" style="display:none;">
                 ...
                 <div class="search_header" id="cohort_title" style="display:inline;padding-bottom:3px;"><div style="width:17px;float:left;"><img src="images/main/toggle_close.jpg" vspace="3" alt="Cohort Options" title="Cohort Options" id="toggleSnapshotCohort"></div><div class="cohort_heading"><strong>Limit results to a cohort group of ...</strong></div></div>
  ...
  <tr>
    ...
    <td align="left"><span class="smallTextBlack"><s:text name="execue.cohort.condition.example" /></span></td>
                    ...
                    <!-- <a href="#"><img src="images/main/celar.jpg" alt="Clear Condition" name="clearCohortCondition"  border="0" id="clearCohortCondition" title="Clear Condition" /></a>
                    <img src="images/main/addCondition.gif" align="middle"
							id="addCohortCondition" alt="Add Condition" title="Add Condition"/> -->
                            
                            <div id="clearAndConditionButtonsCohort" >
                   <!--div id="clearButton"><a href="#"><img id="clearCondition" src="images/main/celar.jpg" title="Clear Condition" alt="Clear Condition"  border="0" /></a> </div-->
                   <!--div id="conditionButtonCohort"><img hspace="3" src="images/main/addConditionNew.gif" align="left" id="addCohortCondition" alt="Add Condition" title="Add Condition" /></div--></div>
                    ...
                    <TD  colspan="2" align="left"  >
                      <div style="display:inline;">
                        <div style="width:160px;float:left;paddin-right:5px;">
                          <a href="#" >
                            <img src="images/main/c1_qi_advanced_options.gif" alt="Advanced Options" name="Image3" width="147" height="27" border="0" align="left" id="Image3" title=								"Advanced Options" onMouseOver="MM_showMenu(window.mm_menu_0105220345_0,0,27,null,'Image3')"
                ...
                <tr>
                  ...
                  <td width="89%">Query Snapshot</td>
					...
					<tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="97%"><div class="sub_links_qs" style="padding-left:17px;"><img src="images/main/arr1.jpg"  vspace="3"></div><div class="sub_links_qs" style="padding-left:3px;"><b>Query Snapshot</b></div></td><td width="3%"><span id="closeQS"><img src="images/main/deleteButton1.jpg" width="13" height="13" alt="Close" border="0" /></span></td>
  </tr>
</table>
					...
					<tr>
						<td align="center" valign="middle">
							<div id="pleaseWaitDiv" style="display: none; margin: auto; width: 133px; margin-top: 5px; margin-bottom: 5px;">
								<img id="waiting_img" src="images/main/wait.gif" width="133" height="11" />
							</div>
						</td>
					</tr>
