...
<link href="<c:out value="${basePath}"/>/css/main/reporting/jquery-ui-1.7.1.custom.css" rel="stylesheet" type="text/css" />
<link rel="stylesheet" type="text/css" media="screen"
	href="<c:out value="${basePath}"/>/css/common/ui.jqgrid.css" />
<style type="text">
   html, body {
...
<script src="<c:out value="${basePath}"/>/js/common/jquery.js" type="text/javascript"></script>
<script src="<c:out value="${basePath}"/>/js/common/i18n/grid.locale-en.js" type="text/javascript"></script>
<script src="<c:out value="${basePath}"/>/js/common/jquery.jqGrid.min.js" type="text/javascript"></script>
...
$.each( colNamesArray, function(k,v) {
	var formatType = "";
	var textAlign = "left";
	if(colHeaderTypeArray[k] == 'MEASURE'){
		formatType = "number";
		textAlign = "right";
	} else { 
