 ...
 * @since 20/08/09
 */
public interface ISforceDataAccessService {

   public Date getLastModifiedData (String sObjectName) throws SforceException;

   public Date getLastModifiedMeta (String sObjectName) throws SforceException;
   ...
   public SObjectMetaEntity getSObjectMetaByName (final String sobjectName) throws SforceException;
