...
<style>
.login_bg {
	background-image: url(../images/admin/login_r2_c1.jpg);
}
...
height:25px;
  ...
  <tr >
    ...
    <table width="1166" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td width="8%" valign="top"><div style="padding:0px;"><a href="<c:out value='${mainPath}'/>/index.jsp"><img name="index_r1_c1" src="../images/admin/inner-page-logo.png" border="0"
