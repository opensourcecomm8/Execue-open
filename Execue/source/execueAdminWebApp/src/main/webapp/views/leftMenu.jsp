...
function hideLoaderImageOnLoad(){
...
tempImg = $("#waiting_img2").attr("src");
		...
		setTimeout(function(){document.images["waiting_img2"].src = tempImg; $("#waiting_img2").show(); }, 1); 	
}
</script>