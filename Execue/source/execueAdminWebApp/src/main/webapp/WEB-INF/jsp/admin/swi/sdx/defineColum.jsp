                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td height="40"><span class="fieldNames">
                          <label>
                            <input type="image" name="imageField3" id="imageField3" src="../images/admin/submitButton.jpg">
                          </label>
                          <label>
                            <input type="image" name="imageField3" id="imageField4" src="../images/admin/resetButton.gif">
                          </label>
                        </span></td>
                      </tr>
                    </table>
