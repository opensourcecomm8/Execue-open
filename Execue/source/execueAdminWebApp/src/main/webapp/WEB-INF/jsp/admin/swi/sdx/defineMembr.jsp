                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td height="40"><span class="fieldNames">
                          <label>
                            <input type="image" name="imageField4" id="imageField5" src="../images/admin/submitButton.jpg">
                          </label>
                          <label>
                            <input type="image" name="imageField4" id="imageField6" src="../images/admin/resetButton.gif">
                          </label>
                        </span></td>
                      </tr>
                    </table>
