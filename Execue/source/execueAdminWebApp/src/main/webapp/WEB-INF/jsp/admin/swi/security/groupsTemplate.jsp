...
<table width="100%" border="0" align="center" cellpadding="0"
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td height="29" class="titleWithBackground"><s:text
					name="execue.group.pageHeading" /></td>
			</tr>
		</table>
		</td>
	</tr>
	<tr>
			...
			<tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <div id="addNewGroupLink"><a class="arrowBg" href="javascript:;"
			id="addNewGroup"><s:text name="execue.group.link.addNewGroup" /></a></div>
		<div id="loadingAddNewGroupLink" style="display: none;"><img
        ...
        <div id="closeInnerPaneLink" style="display:none;" ><a class="arrowBg" href="javascript:;"
			id="closeInnerPane"><s:text name="execue.group.showAllGroups.link" /></a></div>
		<div id="loadingCloseInnerPaneLink" style="display: none;"><img
			src="../images/admin/loading.gif" width="20" height="20"></div>
                  ...
                  <tr>
                    <td width="100%" height="25"><s:text name="execue.groups.description" /></td>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<div id="dynamicPane"><jsp:include
							page="/WEB-INF/jsp/admin/swi/security/groupList.jsp" /></div>
						</td>
					</tr>
					<tr>
						<td>&nbsp;</td>
