...
<table border="0" cellpadding="0" cellspacing="0" width="335" align="left" >
     ...
     src="<c:out value="${basePath}"/>/images/admin/boxTemplate_r1_c1.gif" width="15" height="40"
     border="0" id="boxTemplate_r1_c1" alt="" /></td>
          <td background="<c:out value="${basePath}"/>/images/admin/boxTemplate_r1_c2.gif"><img
     name="boxTemplate_r1_c2" src="<c:out value="${basePath}"/>/images/admin/boxTemplate_r1_c2.gif"
     width="179" height="40" border="0" id="boxTemplate_r1_c2" alt=""/></td>
          <td width="15"><a href="#" id="closeButtonId" ><img
     name="boxTemplate_r1_c3" src="<c:out value="${basePath}"/>/images/admin/boxTemplate_r1_c3_1.gif"
     width="15" height="40" border="0" id="boxTemplate_r1_c3"
     alt="Close" title="Close"/></a></td>
          <td width="13"><img src="<c:out value="${basePath}"/>/images/admin/spacer.gif" width="1" height="40"
     border="0" alt="" /></td>
          </tr>
        <tr>
          <td background="<c:out value="${basePath}"/>/images/admin/boxTemplate_r2_c1.gif"><img
     name="boxTemplate_r2_c1" src="<c:out value="${basePath}"/>/images/admin/boxTemplate_r2_c1.gif"
     width="15" height="10" border="0" id="boxTemplate_r2_c1" alt="" /></td>
          ...
          <td background="<c:out value="${basePath}"/>/images/admin/boxTemplate_r2_c3.gif" ><img
     name="boxTemplate_r2_c3" src="<c:out value="${basePath}"/>/images/admin/boxTemplate_r2_c3.gif"
     width="15" height="10" border="0" id="boxTemplate_r2_c3" alt="" /></td>
          <td><img src="<c:out value="${basePath}"/>/images/admin/spacer.gif" width="1" height="10"
     border="0" alt="" /></td>
          </tr>
        <tr>
          <td><img name="boxTemplate_r3_c1"
     src="<c:out value="${basePath}"/>/images/admin/boxTemplate_r3_c1.gif" width="15" height="13"
     border="0" id="boxTemplate_r3_c1" alt="" /></td>
          <td background="<c:out value="${basePath}"/>/images/admin/boxTemplate_r3_c2.gif" valign="top"><img
     name="boxTemplate_r3_c2" src="<c:out value="${basePath}"/>/images/admin/boxTemplate_r3_c2.gif"
     width="25" height="13" border="0" id="boxTemplate_r3_c2" alt="" /></td>
          <td><img name="boxTemplate_r3_c3"
     src="<c:out value="${basePath}"/>/images/admin/boxTemplate_r3_c3.gif" width="15" height="13"
     border="0" id="boxTemplate_r3_c3" alt="" /></td>
          <td><img src="<c:out value="${basePath}"/>/images/admin/spacer.gif" width="1" height="13"
     border="0" alt="" /></td>
          </tr>
        </table>
</div>
...
<table width="100%" border="0" align="center" cellpadding="0"
	...
	<tr>
      ...
      <tr>
        <td height="23" width="50%"> <jsp:include page='/views/admin/showSelectAsset.jsp' flush="true"/></td>
     
        <td height="20" width="50%" align="right"><!--div><a href="<c:out value="${basePath}"/>/swi/showAssets.action" class="arrowBg"><s:text name="showAssets.showAssets.linkName" /></a></div--></td>
      </tr>
    </table></td></tr>
			...
			<!-- tr>
          <td valign="top" background="images/admin/blueLine.jpg"><img src="<c:out value="${basePath}"/>/images/admin/blueLine.jpg" width="10" height="1" /></td>
          </tr -->
			<tr>
				<td valign="top">
				...
				<table width="400" border="0" align="center" cellpadding="0"
					...
					<tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<table width="99%" border="0" cellspacing="0" cellpadding="0">
									...
									src="<c:out value="${basePath}"/>/images/admin/loaderAT.gif" ></div>
						...
						<table border="0" cellpadding="0" cellspacing="0">
							<!-- fwtable fwsrc="<c:out value="${basePath}"/>/blueBox.png" fwpage="Page 1" fwbase="blueBoxLeft.jpg" fwstyle="Dreamweaver" fwdocid = "466227697" fwnested="1" -->
							<tr>
							...
							<tr>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									src="<c:out value="${basePath}"/>/images/admin/loaderBT.gif" ></div>
      ...
      <td><div id="mapsContent" class="descriptionText" style="width:400px;display:none;" ></div></td>
							...
							<tr>
								...
								<div id="loadingSuggestConceptsLink" style="display: none;"><img
									src="<c:out value="${basePath}"/>/images/admin/loadingWhite.gif" width="25" height="25"></div></div>
                                ...
                                <option value="0">Select..</option>
                                 ...
                                 <!-- filter  ends-->
									...
									src="<c:out value="${basePath}"/>/images/admin/loaderMappings.gif" ></div>
                                    ...
                                    <!-- loader ends -->
										...
										<table width="100" border="0" cellspacing="2" cellpadding="0" style="margin-top:3px;border:1px solid #CCC;padding-left:5px;padding-bottom:2px;">
											<tr>
												...
												<!--td><span><img src="<c:out value="${basePath}"/>/images/admin/navAll_blue.jpg"
													alt="Show All" title="Show All" id="conceptNavAll"/></span>
													<span><img src="<c:out value="${basePath}"/>/images/admin/navAll_blue_disabled.jpg"
									...
									src="<c:out value="${basePath}"/>/images/admin/loaderMappings.gif" ></div>
                                      ...
                                      <input type="button"	class="buttonSize160" disabled="disabled"
										...
										<span id="conformInstancesProcess" style="display: none"><img
											src="<c:out value="${basePath}"/>/images/admin/loadingWhite.gif" width="136" height="27"
											hspace="3" vspace="5" />
										</span> 
										</span> 
