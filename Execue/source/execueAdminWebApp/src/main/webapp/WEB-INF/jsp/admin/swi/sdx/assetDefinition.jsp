...
<table width="375" border="0" align="left" cellpadding="3"
	...
	<tr>		
		<td width="30%" class="fieldNames"><s:text
	...
	<tr>
		...
		<td width="70%"><s:textfield name="asset.displayName"
    ...
    <s:if test="asset.id != null">
     <tr>
		...
		<td width="70%"><s:property value="asset.type"/></td>            
	</tr>
	<tr>
        <td class="fieldNames"><s:text
    ...
    <s:if test="asset.id != null && asset.baseAssetId == null">      
    <tr>
        <td class="fieldNames"><s:text name="execue.asset.ws.asset.label.query.execueion"></s:text></td>        
        <td>    
         <s:if test="asset.queryExecutionAllowed.value == 'Y'">
            <input id="queryExecutionAllowedId" type="checkbox" checked="checked"/>                        
         </s:if>
         <s:else>            
             <input id="queryExecutionAllowedId" type="checkbox"/>             
         </s:else>
        </td>
	...
	<tr>
		...
		<td height="15" colspan="4" align="left"><s:if
			...
			<span class="rightButton"> <input type="button"	class="buttonSize108" id="imageField2"
				...
				onclick="document.assetDefinitionForm.reset();" /> </span>
		</s:else> <!--img id="imageField2" src="../images/admin/clearAllFieldsButton.gif" /-->
		<!--
      <s:if test="asset.id != null">
      <img id="imageField3"  src="../images/admin/analyzeAssetButton.gif" onclick="javascript:analyzeActivateAsset();"/>
      </s:if>
         ...
         <table width="100%" border="0" align="right" cellpadding="0" cellspacing="0" >
		   ...
		   <tr>
		     <td><table width="100%" border="0" cellspacing="0" cellpadding="5">
		      <!-- <tr> TODO-JT- Need to fix this screen first then will enable showConstraints link
		         <td align="left"><a href="../swi/showConstraints.action"><s:text name='execue.assetDefinition.constraints' /></a></td>
	            </tr>-->
		       <tr>
		         <td align="left"><a id="assetGrainLink" href="javascript:showAssetsGrain();"><s:text name='execue.assetDefinition.granularity' /></a><span id="assetGrainLinkLoader" style="display:none;"><img src="../images/admin/loaderTrans.gif" /></span></td>
	            </tr>
		       <tr>
		         <td align="left"><a id="assetDetailsLink" href="javascript:showAssetDetail();"><s:text name='execue.assetDefinition.datasetDetails' /></a><span id="assetDetailsLinkLoader" style="display:none;"><img src="../images/admin/loaderTrans.gif" /></td>
	            </tr>
	            <tr>
