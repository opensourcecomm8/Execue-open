                      ...
                      <s:iterator value="applicationsList" status="appStatus" >                 
                            ...
                            <tr>
                              <s:if test="applicationImageId != -1">
                                ...
                                <div class="imgOuter" style="background:url(../images/admin/loadingBlue.gif) no-repeat center center;width:70px;height:70px;"><img src="qi/getImage.action?applicationId=<s:property value='applicationId'/>&appImageId=<s:property value='applicationImageId'/>"  border="0" width="70" /></div>
                                </a></td>
                                </s:if>   
                              <s:else>
                                <td width="15%"  align="left"  class="pagingTop"  height="85"><a href='<c:url value="/appIndex.action?applicationId=${applicationId}&application.name=${fn:replace(applicationName,' ','_')}"/>' style="float:left">
                                <div class="imgOuter" style="background:url(../images/admin/loadingBlue.gif) no-repeat center center;width:70px;height:70px;">
                                <img src="../images/admin/noImage-icon.gif" border="0" width="70" ></img>
                                </div>
                                </a></td>
                                </s:else>  
