		...
		<table width="50%" border="0" align="center" cellpadding="0"
			...
			<tr>
				<td valign="top" class="descriptionText"><s:text
					name="execue.conceptTypeAssociation.job.description" /></td>
			</tr>
			<tr>
				<td valign="top">
				...
				<table width="200" border="0" align="center" cellpadding="0"
					...
					<tr>
						...
						<div class="innerPane" style="width: 99%"><s:form id="conceptTypeAssociationForm"
							namespace="/swi" action="associateConceptWithType" method="post"
									...
									<table width="50%" border="0" align="center" cellpadding="3"
										...
										<tr> 
											<td  width="24%" class="fieldNames" style="white-space:nowrap"><s:text
												name="execue.ConceptTypeAssociation.upload.source-file" /></td>
