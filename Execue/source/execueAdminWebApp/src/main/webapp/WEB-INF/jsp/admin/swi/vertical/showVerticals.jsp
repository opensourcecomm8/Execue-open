		...
		<table width="98%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td height="25"><a href="javascript:createNewVertical();this.blur()"
							class="arrowBg" id="addNewVertical"><s:text
							name='Add New Vertical' /></a> <!--div id="loadingAddNewConceptLink" style="display:none;"><img src="../images/loading.gif" width="20" height="20" /></div--></td>
					</tr>
