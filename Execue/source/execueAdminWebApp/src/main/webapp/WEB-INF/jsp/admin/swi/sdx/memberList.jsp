  ...
  <tr><td> 
     <table width="100%" height="30">
	   <tr>						   
		   ...
		   <td width="70%">
		     <div id="paginationDiv1"><pg:paginateResults /></div>					
		   </td>
	   </tr>
	 </table>  
    </td></tr>
...
<s:hidden name="searchType" id="memberSearchTypeId"/>
<s:hidden name="searchString" id="memberSearchStringId"/>
<script>
$("#divSearchMember").searchRecordsComponent({actionName:"../swi/getSubMembersInfo.action?paginationType=member",targetDivName:"memberIno"});
