            ...
            <table width="60%" border="0" align="center" cellpadding="3" cellspacing="0">
              ...
              --><tr>
                ...
                <td height="40"><span class="fieldNames">
                  <input type="image" name="imageField" id="imageField" src="../images/admin/submitButton.jpg" />
                <input type="image" name="imageField2" id="imageField2" src="../images/admin/resetButton.gif" />
                </span></td>
              </tr>
              <tr>
