										...
										<table width="100%" border="0" cellpadding="0" cellspacing="1"
											...
											<s:iterator value="assets" status="even_odd" id="asset">
												<tr>
													...
													<td align="center"><a
														href="editAsset.action?asset.id=<s:property value='id' />&asset.name=<s:property value='name' />"
													...
													<td align="center"><s:if
														...
														<div id="loadingShowStatus<s:property value="id"/>Link"
															...
															src="../images/admin/loadingWhite.gif" width="20" height="20"></div>
													</s:if> <s:else>
														<div id="showStatus<s:property value="id"/>Link"><a
															href="javascript:showAssetStatus('<s:property value="id"/>');">
                                                    ...
                                                    href="javascript:validateAssetUnderMaintenance(<s:property value="id"/>);"><img
                                                    src="../images/admin/disabledIcon.gif" alt="Delete" width="25"
