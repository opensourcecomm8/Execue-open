...
<table width="100%" border="0" align="center" cellpadding="0"
	...
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td height="29" class="titleWithBackground">Search Audit Result</td>
			</tr>
		</table>
		</td>
	</tr>
...
$(document).ready(function() {
  ...
  //  alert(queryString);
	...
	$('#grid').jqGrid({
	  url: 'showQISearchAuditDetail.action?'+queryString,
      datatype: 'json',
      mtype: 'GET',
	  width: 950,
	  height: 270,
      ...
      viewrecords: true,
	  gridview: true,
	  colNames:[ "id",'User','Search Request','Source','Reports Link','Application'],
	  colModel:[
				...
				{name:"queryString",width:90,sortable:false, search:false},	
				{name:"assetName",width:100,sortable:false, search:false},	
				{name:"aggregatedQueryIds",width:100,sortable:true,sorttype:"text", search:false},
				{name:"appName",width:130, sortable:true, search:false}],				
	jsonReader: {
	    repeatitems: false
	},
