...
<table id="rangeDefinitionDetailSubmits" width="100%">
    ...
    <tr align = "center">
      ...
      <div id="showAddToDimensionLink"> <input type="button" value="Add to Selection" onclick="javascript: addDimension();"></div>
	  <div style="display: none;" id="loadingShowAddToDimensionLink"><img height="16" src="../images/admin/loadingWhite.gif"></div>
      </s:else>
      </td>
    </tr>
</table>
