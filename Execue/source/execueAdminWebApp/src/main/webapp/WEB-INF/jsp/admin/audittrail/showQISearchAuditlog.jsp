...
<table width="100%" border="0" align="center" cellpadding="0"
	...
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td height="29" class="titleWithBackground">Search Audit Log</td>
			</tr>
		</table>
		</td>
	</tr>
					...
					<tr>
						<td height="350" align="left" valign="top">
						   <!-- form start -->
						      ...
						      <form id="qiSearchAuditLogSearchForm" action='searchQISearchAuditlog.action' accept-charset="utf-8" method="post">                    
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
								 <tr>
	...
	$(function(){
		 ...
		 $("#searchBtn").click(function(){
		    var userIndex=0; 
		     ...
		     var userAccessAuditInputId="<input type='hidden' name='userAccessAuditInput.id' value='-1'></input>";				    
		     $("#hiddenFieldDiv").append(userAccessAuditInputId);		 
	      ...
	      $("#qiSearchAuditLogSearchForm").submit();
