	...
	<tbody>
		<tr>
			...
			<div style="display: none;" id="loadingShowInstanceLink"><img
				height="20" width="20" src="../images/admin/loading.gif"></div>
			</td>
		</tr>
							...
							<tbody>
								<tr>
									...
									<div style="width: 565px; height: auto;display:none;"
                                        ...
                                        <div style="width: 576px; height: 288px;display:none;border:1px solid #ccc;background:url('../images/admin/loadingBlue.gif') no-repeat center center;margin-top:10px;"
