...
<%@ taglib prefix='security'
   ...
   <%@page import="com.execue.web.core.util.ExecueWebConstants"%>
    <c:set var="mainPath" value="<%=application.getAttribute(ExecueWebConstants.MAIN_CONTEXT)%>" />
...
<style>
.login_bg {
	background-image: url(<c:out value="${basePath}"/>/images/admin/login_r2_c1.jpg);
}
</style>
<style>
.login_bg {
...
<style>
.top-bg {
	background-image: url(<c:out value="${basePath}"/>/images/admin/results_header_bg.jpg);
...
.technology-1 {
	background-image: url(<c:out value="${basePath}"/>/images/admin/top-bg-inner-2.png);
	background-repeat: repeat-x;
...
<div style="margin:auto;width:91%">
                          ...
                          <tr>
                            <td width="56%" height="20" align="center"><!-- sub links starts -->
                              &nbsp;</td>
                                    ...
                                    <td width="30%" align="center"><div id="showWelcome" style="padding-right:20px;color:#333;padding-top:0px;padding-right:18px;font-family:'Trebuchet MS', Arial, Helvetica, sans-serif;text-align:right;width:500px;margin:auto;">
   </div></td>
  ...
  <tr >
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="8%" valign="top"><div style="padding-top:0px;padding-left:0px;padding-right:0px;padding-bottom:1px;"><a href="<c:out value='${mainPath}' />/index.jsp"><img name="index_r1_c1" src="<c:out value="${basePath}"/>/images/admin/inner-page-logo.png" border="0"
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr >
		<td height="25"  class="normalText" background="images/admin/bc-bg.jpg" >
		<span style="padding-left:1px;color:#333;">
                <a href="<c:out value="${mainPath}"/>index.jsp"	 class="breadCrumbLink"><s:text name="execue.home.link" /></a><Span class="textArrow"> >> </Span> <span class="breadCrumbNoLink"><s:text name="execue.SignIn.breadcrumb" /></span>
		</span></td>
	</tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="680"> 
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="32%"><DIV id=feedbackIntro
				style="background-color: #F3F4FE; border: 1px #DFE8FD solid; width: 78%; padding-left: 20px; min-height: 280px; height:auto;float: right; margin-top: 5px; padding-right: 20px;">
								...
								<table cellspacing="0" cellpadding="2" width="70%"
									...
									<tr>
										...
										<td height="30" align="left"><label> <input
											...
											src="<c:out value="${basePath}"/>/images/admin//login_submit.gif"> <a
...
<table align="left" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		<td colspan="3"><jsp:include page="views/footer-search.jsp" flush="true" /></td>
...
<tr>
     ...
     src="images/admin/boxTemplate_r1_c1.gif" width="15" height="40"
     border="0" id="boxTemplate_r1_c1" alt="" /></td>
      <td background="images/admin/boxTemplate_r1_c2.gif"><img
     name="boxTemplate_r1_c2" src="images/admin/boxTemplate_r1_c2.gif"
     width="279" height="40" border="0" id="boxTemplate_r1_c2" alt=""/></td>
          <td width="15"><img
     name="boxTemplate_r1_c3" src="images/admin/boxTemplate_r1_c3.gif"
     width="15" height="40" border="0" id="boxTemplate_r1_c3"
     alt="Close" title="Close"/></td>
          <td width="13"><img src="images/admin/spacer.gif" width="1" height="15"
     border="0" alt="" /></td>
        </tr>
        <tr>
          <td background="images/admin/boxTemplate_r2_c1.gif"><img
     name="boxTemplate_r2_c1" src="images/admin/boxTemplate_r2_c1.gif"
     width="15" height="10" border="0" id="boxTemplate_r2_c1" alt="" /></td>
          ...
          <td background="images/admin/boxTemplate_r2_c3.gif" ><img
     name="boxTemplate_r2_c3" src="images/admin/boxTemplate_r2_c3.gif"
     width="15" height="1" border="0" id="boxTemplate_r2_c3" alt="" /></td>
          <td><img src="images/admin/spacer.gif" width="1" height="10"
     border="0" alt="" /></td>
        </tr>
        <tr>
          <td><img name="boxTemplate_r3_c1"
     src="images/admin/boxTemplate_r3_c1.gif" width="15" height="13"
     border="0" id="boxTemplate_r3_c1" alt="" /></td>
          <td background="images/admin/boxTemplate_r3_c2.gif" valign="top"><img
     name="boxTemplate_r3_c2" src="images/admin/boxTemplate_r3_c2.gif"
     width="25" height="13" border="0" id="boxTemplate_r3_c2" alt="" /></td>
          <td><img name="boxTemplate_r3_c3"
     src="images/admin/boxTemplate_r3_c3.gif" width="15" height="13"
     border="0" id="boxTemplate_r3_c3" alt="" /></td>
          <td><img src="images/admin/spacer.gif" width="1" height="13"
     border="0" alt="" /></td>
        </tr>
  </table>
</div>
