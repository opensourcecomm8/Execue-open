...
.top-bg {
	background-image: url(<c:out value="${basePath}"/>/images/admin/header_top.png);
	background-repeat: repeat-x;
...
<div style="margin:auto;width:91%">
                          ...
                          <tr>
                            <td width="41%" height="20" align="right"><!-- sub links starts -->
                              ...
                              <div style="height:16px;padding-top:2px;z-index:20;position:absolute;" id="waitImage"><div id="pleaseWaitDiv" style="display: none; margin: auto; width: 110px;">
								<img id="waiting_img" src="<c:out value="${basePath}"/>images/admin/Loader-main-page-3.gif" width="22" height="22" />
							</div>
                        </div></td>
                                    ...
                                    <td width="45%" align="center"><div id="showWelcome" style="padding-right:20px;color:#3F5356;padding-top:0px;padding-right:18px;font-family:'Trebuchet MS', Arial, Helvetica, sans-serif;text-align:right;width:200px;margin:auto;">
   </div></td>
  ...
  <tr >
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="8%" valign="top"><div style="padding-top:4px;padding-left:0px;padding-right:0px;padding-bottom:1px;"><a href="<c:out value='${mainPath}'/>/index.jsp"><img name="index_r1_c1" src="<c:out value="${basePath}"/>/images/admin/inner-page-logo.png" border="0"
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr >
		<td height="25"  class="normalText" background="images/admin/bc-bg.jpg" style="font-family:Arial, Helvetica, sans-serif;font-size:12px;" >
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="30" valign="middle" background="<c:out value="${basePath}"/>/images/admin/semantifi3b/footer-bg-3.jpg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
