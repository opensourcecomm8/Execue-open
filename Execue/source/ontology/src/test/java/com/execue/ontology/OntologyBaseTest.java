...
package com.execue.ontology;

import org.springframework.context.ApplicationContext;
import org.springframework.context.support.ClassPathXmlApplicationContext;

import com.execue.core.system.ExeCueSystemConfigurationUtility;
import com.execue.ontology.service.impl.DBOntologyServiceImpl;

public abstract class OntologyBaseTest {
   ...
   public static void baseSetup () {
      context = new ClassPathXmlApplicationContext(new String[] { "/platform/bean-config/execue-ontology.xml",
   ...
   public DBOntologyServiceImpl getDBOntologyService () {
      return (DBOntologyServiceImpl) context.getBean("dbOntologyService");
   }
