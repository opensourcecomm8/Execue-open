...
public class QueryGenerationCommonBaseTest extends QueryGenerationBaseTest {
   ...
   private RangeDetail getRangeDetail (Range range, Integer order, String description, Double lowerLimit,
            Double upperLimit) {
   ...
   private LimitEntity createLimitEntity (int i) {
      ...
      limitEntity.setEndingNumber(new Long(i));
      return limitEntity;
   }
