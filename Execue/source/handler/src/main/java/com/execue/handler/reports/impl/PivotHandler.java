...
public class PivotHandler implements IReportHandler {

   public void handleReport (UniversalReport universalReport, ReportListWrapper ouputReports,
            HttpServletRequest request, HttpServletResponse response) throws HandlerException {
      throw new HandlerException(PresentationExceptionCodes.DEFAULT_EXCEPTION_METHOD_NOT_SUPPORTED,
