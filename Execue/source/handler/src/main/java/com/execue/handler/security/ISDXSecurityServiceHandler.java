...
public interface ISDXSecurityServiceHandler {

   public void addAssetsPermission (String roleName, List<Long> selectedAssetIds, List<Long> permittedAssetIds)
            throws HandlerException;

   public void addTablesPermission (String roleName, List<Long> selectedTableIds, List<Long> permittedTableIds)
            throws HandlerException;
   ...
   public List<Long> getPermittedAssetIdsForRole (String roleName, List<Asset> pageAssets) throws HandlerException;
