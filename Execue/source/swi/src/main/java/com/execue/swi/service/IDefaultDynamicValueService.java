...
public interface IDefaultDynamicValueService extends ISWIService {
   ...
   public void deleteDefaultDynamicValues (List<DefaultDynamicValue> defaultDynamicValue) throws MappingException;
