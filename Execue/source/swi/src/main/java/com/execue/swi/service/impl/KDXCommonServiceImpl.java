...
import com.execue.swi.service.IKDXCommonService;

public abstract class KDXCommonServiceImpl implements IKDXCommonService {

   private IKDXDataAccessManager kdxDataAccessManager;

   public void deleteBusinessEntityVariations (Long entityBedId) throws KDXException {
      getKdxDataAccessManager().deleteBusinessEntityVariationsByBedId(entityBedId);
   }
