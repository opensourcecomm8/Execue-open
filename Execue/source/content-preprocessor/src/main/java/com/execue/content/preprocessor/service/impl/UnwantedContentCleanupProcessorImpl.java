 ...
 */
public class UnwantedContentCleanupProcessorImpl implements IUnwantedContentCleanupProcessor {

   @Override
   public String processContent (String newsItemLine, Long applicationId) throws ContentPreProcessorException {
      newsItemLine = ContentPreProcessorHelper.removeContinuousChars(newsItemLine);
      return newsItemLine;
   }
}
