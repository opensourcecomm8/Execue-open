 ...
 */
public class ContentMarkupTagCleanupProcessorImpl implements IContentMarkupTagCleanupProcessor {

   @Override
   public String processContent (String newsItemLine, Long applicationId) throws ContentPreProcessorException {
      return ContentPreProcessorHelper.getTrimmedForHTMLTags(newsItemLine);
   }
}
