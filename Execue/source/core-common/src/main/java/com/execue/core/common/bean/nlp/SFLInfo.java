...
public class SFLInfo {
   ...
   private List<Integer> requiredTokens;
   private List<Integer> primaryTokens;
   private Integer       requiredCount;

   /**
    * @return the requiredTokens
    */
   public List<Integer> getRequiredTokens () {
      return requiredTokens;
   }

   /**
    * @param requiredTokens
    *           the requiredTokens to set
    */
   public void setRequiredTokens (List<Integer> requiredTokens) {
      this.requiredTokens = requiredTokens;
   }

   /**
    * @return the primaryTokens
    */
   public List<Integer> getPrimaryTokens () {
      return primaryTokens;
   }

   /**
    * @param primaryTokens
    *           the primaryTokens to set
    */
   public void setPrimaryTokens (List<Integer> primaryTokens) {
