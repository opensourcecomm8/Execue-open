 ...
 * @author kaliki
 */
public enum StatusEnum implements IBaseEnumType {
   ACTIVE ("A"), INACTIVE ("I"), DELETE ("D");

   private String                               value;
   private static final Map<String, StatusEnum> reverseLookupMap = new HashMap<String, StatusEnum>();
   private static String                        name             = StatusEnum.class.getSimpleName();
