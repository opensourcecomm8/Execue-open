...
public class AssetQuery {
   ...
   private StructuredQuery logicalQuery;
   private Query           physicalQuery;
   private Long            userQueryId;

   public StructuredQuery getLogicalQuery () {
      return logicalQuery;
   }

   public void setLogicalQuery (StructuredQuery logicalQuery) {
      this.logicalQuery = logicalQuery;
   }

   public Query getPhysicalQuery () {
      return physicalQuery;
   }

   public void setPhysicalQuery (Query physicalQuery) {
