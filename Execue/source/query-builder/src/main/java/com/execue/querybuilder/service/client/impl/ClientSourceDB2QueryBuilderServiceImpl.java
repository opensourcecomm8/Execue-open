...
public class ClientSourceDB2QueryBuilderServiceImpl extends ClientSourceQueryBuilderServiceImpl {
   ...
   public String getDynamicRangesQuery (String rangeColumnAlias, String innerQueryString, int[] band) {
      ...
      queryString.append(ClientSourceQueryBuilderServiceHelper.surroundWithSpaces(DB2_LIMIT_CLAUSE)).append(
               startingRowPointer).append(SQL_ENTITY_SEPERATOR).append(SQL_SPACE_DELIMITER).append(
               toBeRetrievedRowCount);
      queryString.append(SQL_SUBQUERY_END_WRAPPER).append(SQL_SPACE_DELIMITER).append(DB2_LIMIT_INNER_QUERY_ALIAS_NAME);
