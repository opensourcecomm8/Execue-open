...
public class QueryCacheServiceBaseTest {
   ...
   public static void baseSetup () {
      context = new ClassPathXmlApplicationContext(
               new String[] { "/platform/bean-config/execue-logging-configuration.xml",
                        "/platform/bean-config/execue-configuration.xml",
                        "/ext/bean-config/execue-configuration-ext.xml", "spring-hibernate.xml",
                        ...
                        "platform/bean-config/execue-query-cache.xml",
                        "platform/bean-config/execue-platform-services.xml", "platform/bean-config/execue-swi.xml",
                        ...
                        "platform/bean-config/execue-dataaccess-services.xml", "platform/bean-config/execue-core.xml",
   ...
   public IQueryCacheService getQueryCacheService () {
      return (IQueryCacheService) context.getBean("qcacheService");
   }
