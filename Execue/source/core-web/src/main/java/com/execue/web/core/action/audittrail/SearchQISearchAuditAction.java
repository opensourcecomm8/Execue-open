...
/**
 * Action class to perform search operation for QI search audit log.
 * @author Jitendra
 *
 */

public class SearchQISearchAuditAction extends PaginationGridAction {
   ...
   protected List<? extends IGridBean> processPageGrid () {
      List<UIUserSearchAudit> userSearchAuditList = null;
      try {
         userSearchAuditList = getAuditTrailServiceHandler().getUserSearchAuditLog(userAccessAuditInput,
                  getPageDetail());
