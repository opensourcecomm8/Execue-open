...
public class ContentSemantificationCommonBaseTest extends ContentSemantificationBaseTest {
   ...
   public IGenericArticleResemantificationService getGenericArticleResemantificationService () {
      return (IGenericArticleResemantificationService) getContext().getBean("genericArticleResemantificationService");
   }
